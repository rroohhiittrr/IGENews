...
const PALETTES = [
  { bg: "#1E3A5F", accent: "#F4A024", text: "#ffffff", badge: "#F4A024" },  // Indigo Navy + Saffron Gold
  { bg: "#142840", accent: "#2F6FA3", text: "#ffffff", badge: "#2F6FA3" },  // Dark Navy + Steel Blue
  { bg: "#2F6FA3", accent: "#F4A024", text: "#ffffff", badge: "#F4A024" },  // Steel Blue + Gold
  { bg: "#1E3A5F", accent: "#2E7D32", text: "#ffffff", badge: "#2E7D32" },  // Navy + Export Green
  { bg: "#142840", accent: "#4A8FC2", text: "#ffffff", badge: "#4A8FC2" },  // Deep Navy + Sky Blue
];
      ...
      <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-[6%] pt-[5%]">
        <div className="flex items-center gap-2">
          <img
            ...
            alt="IGE"
            style={{ width: "1.8rem", height: "1.8rem", objectFit: "contain" }}
          />
          <img
            src="/images/IGENews_logo.svg"
            alt="India Global Expo News"
            style={{ height: "0.9rem", objectFit: "contain", filter: "brightness(0) invert(1)", opacity: 0.8 }}
          />
        </div>
        {article.isTrending && (
          <span
