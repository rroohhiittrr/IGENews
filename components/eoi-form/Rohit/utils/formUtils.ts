...
// VALIDATE STEP 1
// ──────────────────────────────────────────────────────────────────────────────
export function validateStep1(data: Record<string, any>): Record<string, string> {
...
// VALIDATE STEP 2
// ──────────────────────────────────────────────────────────────────────────────
export function validateStep2(data: Record<string, any>): Record<string, string> {
  const errors: Record<string, string> = {};
...
export function validateStep3(productId: ProductId, data: Record<string, string | string[] | boolean>): Record<string, string> {
  ...
  switch (productId) {
    ...
    case "p1_indian_exporter":
      ...
      break;
    case "p2_global_importer":
      required("legal_name", "Company name is required");
      required("country_origin", "Country of origin is required");
      required("import_products", "Primary import products is required");
      break;
    case "p3_global_exporter":
      required("country_origin", "Country of origin is required");
      required("export_products", "Primary products exported is required");
      break;
    case "p4_indian_importer":
    ...
    case "p11_nomination":
      ...
      break;
    case "p12_sponsorship":
      required("tier", "Sponsorship tier is required");
      break;
    case "p13_branding":
      required("message", "Brand message is required");
      break;
    case "p14_certification":
      required("certs", "Please select certification type");
      break;
    case "p15_conference":
      required("roles", "Please select conference role");
      break;
    case "p16_sponsorships":
      required("tier", "Sponsorship tier is required");
      break;
    case "p17_speakers":
      required("topic", "Proposed topic is required");
      break;
    case "p18_delegates":
      required("seats", "Number of seats is required");
      break;
    case "p19_awards":
      required("achievement", "Achievement description is required");
      break;
    case "p20_research_media":
      required("scopes", "Please select research scope");
      break;
    case "p21_sso_chairman":
      required("sso_role", "Please select your preferred SSO leadership role");
      required("target_sector", "Target GDP sector is required");
      required("session_vision", "Session vision is required");
      break;
  }
