...
export default function ReaderDashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-8 pb-24 text-left">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="relative group shrink-0">
            {avatarBase64 ? (
              ...
              <div className="w-20 h-20 rounded-full bg-[#1E3A5F] text-white flex items-center justify-center font-bold text-xl uppercase shadow">
                {editName.slice(0, 2)}
              </div>
            )}
            <button 
              onClick={() => avatarInputRef.current?.click()}
              className="absolute -bottom-1 -right-1 w-6 h-6 bg-white dark:bg-[#172c47] border border-gray-200 dark:border-white/10 rounded-full flex items-center justify-center shadow hover:text-[#F4A024] transition-all"
              ...
              {isEditingName ? (
                <div className="flex gap-2 items-center">
                  <input 
                    ...
                    className="px-2.5 py-1 bg-gray-100 dark:bg-white/5 text-sm font-bold text-[#1E3A5F] dark:text-white rounded focus:outline-none"
                  />
                ...
                <div className="flex items-center gap-2">
                  <h2 className="text-2xl font-bold text-[#1E3A5F] dark:text-white leading-tight">{editName}</h2>
                  <button onClick={() => setIsEditingName(true)} className="text-gray-400 hover:text-[#F4A024] transition-all" title="Edit Name">
            ...
            <div className="pt-2 flex items-center justify-center md:justify-start gap-2">
              <div className="bg-[#f4f7fb] dark:bg-white/5 px-3 py-1.5 rounded-xl border border-gray-150 dark:border-transparent flex items-center gap-2 max-w-sm">
                ...
                <button 
                  ...
                  className="text-gray-400 hover:text-[#1E3A5F] dark:hover:text-white shrink-0"
      ...
      <div className="bg-[#1E3A5F] dark:bg-[#122238] rounded-2xl py-3 px-4 border border-white/5 shadow-sm mb-8 overflow-hidden relative flex items-center">
        <div className="bg-[#F4A024] text-white text-[9px] font-black px-2 py-1 rounded uppercase tracking-wider shrink-0 mr-4 z-10 shadow-sm">
          Breaking
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm text-left">
            ...
            <div className="flex items-center justify-between border-b border-gray-100 dark:border-white/5 pb-4 mb-6">
              <div>
                <h3 className="font-bold text-[#1E3A5F] dark:text-white text-lg">My Feed</h3>
            ...
            <div className="flex flex-wrap gap-1.5 mb-6 overflow-x-auto pb-1.5 max-h-16">
              ...
              >
                <Sparkles className="w-3.5 h-3.5 text-[#F4A024]" />
                For You
              </button>
            ...
            {activeTab === "for-you" && (
              <div className="bg-orange-500/5 border border-orange-500/15 rounded-2xl p-4 mb-6 flex gap-3 text-left">
                ...
                <div className="space-y-1">
                  <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white">Basic Curation Active</h4>
                ...
                return (
                  ...
                  >
                    <div className="space-y-1.5 flex-1">
                      <div className="flex items-center gap-2">
                        <span className="px-2.5 py-0.5 bg-[#1E3A5F]/10 text-[#1E3A5F] dark:text-blue-300 dark:bg-blue-950/30 text-[9px] font-bold uppercase tracking-wider rounded">
                      ...
                      <h4 className="font-bold text-[#1E3A5F] dark:text-white text-sm hover:text-[#F4A024] cursor-pointer transition-all">{article.title}</h4>
                    ...
                    <div className="flex items-center gap-2 shrink-0 self-end md:self-center">
                      ...
                      <button className="px-3.5 py-2 bg-white dark:bg-white/10 text-[#1E3A5F] dark:text-white border border-gray-200 dark:border-white/10 hover:border-[#F4A024] dark:hover:border-[#F4A024] text-xs font-bold rounded-xl flex items-center gap-1">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm text-left space-y-6">
            <h3 className="font-bold text-[#1E3A5F] dark:text-white text-base border-b border-gray-100 dark:border-white/5 pb-2.5">
              Quick Stats
            </h3>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <span className="text-3xl font-black text-[#1E3A5F] dark:text-white">{articlesRead}</span>
              ...
              <div className="h-2 w-full bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden">
                <div 
                  className={`h-full rounded-full transition-all duration-300 ${
                    savesCount >= 20 ? "bg-red-500" : savesCount >= 15 ? "bg-orange-500" : "bg-[#1E3A5F]"
                  }`} 
            ...
            <div className="space-y-2">
              ...
              <div className="h-2 w-full bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden">
                <div 
                  className={`h-full rounded-full transition-all duration-300 ${
                    followsCount >= 10 ? "bg-red-500" : followsCount >= 8 ? "bg-orange-500" : "bg-[#1E3A5F]"
                  }`} 
          ...
          {savedArticles.length > 0 && (
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm text-left space-y-4">
              <h4 className="font-bold text-[#1E3A5F] dark:text-white text-sm flex items-center justify-between">
                ...
                {savedArticles.map((art) => (
                  <div key={art.id} className="py-2.5 flex items-center justify-between gap-3 text-xs">
                    <div className="space-y-0.5 truncate">
                      <h5 className="font-bold text-gray-700 dark:text-white truncate cursor-pointer hover:text-[#F4A024]">{art.title}</h5>
