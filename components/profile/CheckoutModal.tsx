        ...
        >
          {paymentState === "idle" && (
            <div className="p-6 md:p-8">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-xl font-bold text-[#1E3A5F] dark:text-white">Secure Checkout</h3>
              ...
              <div className="bg-[#f4f7fb] dark:bg-white/5 rounded-2xl p-5 mb-6 border border-gray-100 dark:border-transparent flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-bold uppercase tracking-wider text-[#F4A024] block mb-1">SELECTED PLAN</span>
                  <span className="text-base font-bold text-[#1E3A5F] dark:text-white">{planName}</span>
                </div>
                <div className="text-right">
                  <span className="text-2xl font-black text-[#1E3A5F] dark:text-white">{price}</span>
              ...
              {/* Payment Methods */}
              <div className="mb-6">
                <span className="text-xs font-bold text-[#1E3A5F] dark:text-white/70 block mb-3">Select Payment Method</span>
                    ...
                    return (
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all ${
                          isSelected
                            ? "border-[#1E3A5F] dark:border-[#F4A024] bg-[#1E3A5F]/5 dark:bg-[#F4A024]/5 text-[#1E3A5F] dark:text-white font-bold"
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-sm font-medium text-[#1E3A5F] dark:text-white border-none focus:outline-none focus:ring-2 focus:ring-[#F4A024]"
                      />
                    </div>
                ...
                {method === "netbanking" && (
                  ...
                  >
                    <div>
                      ...
                      <select className="w-full px-4 py-3 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-sm font-semibold text-[#1E3A5F] dark:text-white border-none focus:outline-none focus:ring-2 focus:ring-[#F4A024]">
              ...
              <div className="space-y-3">
                <button
                  onClick={handlePay}
                  className="w-full py-4 bg-gradient-to-r from-[#1E3A5F] to-[#2F6FA3] hover:from-[#2F6FA3] hover:to-[#1E3A5F] text-white font-bold rounded-2xl shadow-lg transition-all text-sm flex items-center justify-center gap-2"
                >
          ...
          {paymentState === "processing" && (
            ...
            >
              <div className="relative flex items-center justify-center">
                ...
                <Loader2 className="w-8 h-8 text-[#F4A024] animate-spin absolute" />
              </div>
              <h3 className="text-lg font-bold text-[#1E3A5F] dark:text-white mt-4">Processing Secure Payment</h3>
          ...
          {paymentState === "success" && (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-[#1E3A5F] dark:text-white mt-4">Payment Successful!</h3>
              <p className="text-xs text-gray-400 max-w-xs">
