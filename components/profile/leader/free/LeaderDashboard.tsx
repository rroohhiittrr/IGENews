          ...
          <div className="lg:col-span-9 space-y-6">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm space-y-4 text-left">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-2xl font-black text-[#1D1D46] dark:text-white">{articles.length} <span className="text-xs text-gray-400">/ 1 month</span></h4>
                  ...
                  <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm space-y-4 text-left">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-xs font-bold text-[#1D1D46] dark:text-white truncate max-w-[130px]">{editCompanyName || "Unlinked"}</h4>
                ...
                <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm text-left space-y-4">
                  <div className="flex items-center justify-between border-b border-gray-150 dark:border-white/5 pb-3">
                    <h3 className="font-bold text-[#1D1D46] dark:text-white">Profile Impact Tracker</h3>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                      ...
                      <span className="text-xl font-bold text-[#1D1D46] dark:text-white">128</span>
                    </div>
                    <div className="p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                      <span className="text-[10px] font-bold text-gray-400 block mb-1">Profile Clicks</span>
                      <span className="text-xl font-bold text-[#1D1D46] dark:text-white">41</span>
                    </div>
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1.5">
                      ...
                      <button type="button" onClick={addTimelineEntry} className="text-[#F0652E] text-[10px] font-bold">+ Add Row</button>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1.5">
                      ...
                      <button type="button" onClick={addEducationEntry} className="text-[#F0652E] text-[10px] font-bold">+ Add Row</button>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mb-2">
                      ...
                      <button type="button" onClick={addExpertise} className="px-4 py-2 bg-[#1D1D46] text-white text-xs font-bold rounded-xl">Add</button>
                    </div>
            ...
            {adminTab === "articles" && (
              <div className="space-y-6 text-left">
                ...
                <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-4">
                  <div>
                    <h3 className="font-bold text-[#1D1D46] dark:text-white">Thought Column Publisher</h3>
                    ...
                    <div className="flex justify-between items-center pt-2">
                      ...
                      <button 
                        ...
                        className={`px-6 py-2.5 text-white text-xs font-bold rounded-xl flex items-center gap-1.5 shadow-md ${
                          articles.length >= 1 ? "bg-gray-300 dark:bg-white/5 text-gray-500 cursor-not-allowed" : "bg-[#1D1D46] hover:bg-[#0642BA]"
                        }`}
                      >
            ...
            {adminTab === "linkage" && (
              <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-6 text-left">
                <div>
                  <h3 className="font-bold text-[#1D1D46] dark:text-white">Company Profile Linkage</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl border border-gray-150 dark:border-white/5 flex items-center justify-between">
                    <div>
                      <h4 className="text-xs font-bold text-[#1D1D46] dark:text-white">{editCompanyName || "Unlinked"}</h4>
                ...
                <div className="space-y-3.5 border-t border-gray-100 dark:border-white/5 pt-4">
                  <h4 className="text-xs font-bold text-[#1D1D46] dark:text-white">Connect to another Company</h4>
                  <div className="space-y-2">
                    <input 
                      type="text" 
                    ...
                    <button 
                      ...
                      className="px-5 py-2 bg-[#1D1D46] hover:bg-[#0642BA] text-white text-xs font-bold rounded-xl shadow"
                    >
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                  ...
                  <div className="bg-white dark:bg-[#122238] border-2 border-gray-150 dark:border-white/5 rounded-[32px] p-6 flex flex-col justify-between shadow-sm">
                    <div className="space-y-4">
                      <div>
                        ...
                        <h4 className="text-base font-bold text-[#1D1D46] dark:text-white">FREE PROFILE</h4>
                  ...
                  <div className="bg-gradient-to-b from-[#1D1D46]/5 to-transparent dark:from-[#1D1D46]/20 dark:to-[#122238]/20 border-2 border-[#1D1D46] dark:border-[#F0652E] rounded-[32px] p-6 flex flex-col justify-between shadow-lg relative overflow-hidden">
                    <div className="absolute top-3 right-3 bg-[#F0652E] text-white text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider">Recommended</div>
                    <div className="space-y-4">
                      <div>
                        <span className="text-[9px] font-bold text-[#F0652E] block uppercase">Verified leadership</span>
                        <h4 className="text-base font-bold text-[#1D1D46] dark:text-white">VERIFIED LEADER</h4>
                        <div className="mt-2 flex items-baseline gap-1">
                          <span className="text-3xl font-black text-[#1D1D46] dark:text-white">₹39,000</span>
                  ...
                  <div className="bg-white dark:bg-[#122238] border-2 border-gray-150 dark:border-white/5 rounded-[32px] p-6 flex flex-col justify-between shadow-sm">
                    <div className="space-y-4">
                      <div>
                        ...
                        <h4 className="text-base font-bold text-[#1D1D46] dark:text-white">LEADER ELITE</h4>
                        <div className="mt-2 flex items-baseline gap-1">
                          <span className="text-3xl font-black text-[#1D1D46] dark:text-white">₹1L - 5L</span>
                          <span className="text-[10px] text-gray-400">/ year</span>
                        </div>
                      </div>
                      <div className="h-px bg-gray-100 dark:bg-white/5 w-full" />
            ...
            {adminTab === "settings" && (
              <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-6 text-left">
                <div>
                  <h3 className="font-bold text-[#1D1D46] dark:text-white">Leader Settings</h3>
                ...
                <div className="border-t border-gray-100 dark:border-white/5 pt-4 flex items-center justify-between">
                  <div>
                    <h4 className="text-xs font-bold text-[#1D1D46] dark:text-white">Current Company Privacy Toggle</h4>
                ...
                <div className="border-t border-gray-100 dark:border-white/5 pt-4 space-y-3">
                  <h4 className="text-xs font-bold text-[#1D1D46] dark:text-white">Email Notification Toggles</h4>
                  <div className="space-y-2">
                    {[
      ...
      {viewMode === "public" && (
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-[#122238] rounded-[32px] border border-gray-150 dark:border-white/5 overflow-hidden shadow-sm">
            <div className="h-40 bg-gradient-to-r from-[#1D1D46] to-[#0642BA] dark:from-[#112238] dark:to-[#172c47] relative overflow-hidden" />
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 -mt-16 sm:-mt-20">
                ...
                <div className="flex-1 text-center sm:text-left space-y-2 pt-1.5">
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2.5">
                    <h1 className="text-2xl sm:text-3xl font-bold text-[#1D1D46] dark:text-white leading-tight font-display">{editFullName}</h1>
                    <div 
                  ...
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-4 gap-y-1.5 text-xs text-gray-500 font-medium">
                    ...
                    {editCompanyName && companyPrivacy && (
                      <span className="flex items-center gap-1">
                        At <span className="font-bold text-[#1D1D46] dark:text-white">{editCompanyName}</span> 
              ...
              {publicTab === "bio" && (
                <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-150 dark:border-white/5 text-left space-y-6 shadow-sm">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-sm font-bold text-[#1D1D46] dark:text-white border-l-4 border-[#F0652E] pl-2.5">Biography Overview</h3>
                      ...
                      <div className="relative border-l border-gray-100 dark:border-white/5 pl-4 ml-2.5 space-y-4">
                        {editTimeline.map((item, idx) => (
                          <div key={idx} className="relative space-y-1">
                            ...
                            <span className="text-[10px] font-bold text-[#F0652E]">{item.years}</span>
                            <h4 className="text-xs font-bold text-[#1D1D46] dark:text-white">{item.role}</h4>
                      ...
                      <div className="space-y-3 pl-2">
                        {editEducation.map((edu, idx) => (
                          <div key={idx} className="text-left text-xs">
                            <h4 className="font-bold text-[#1D1D46] dark:text-white">{edu.institution}</h4>
                ...
                <div className="space-y-4 text-left">
                  {articles.map((art) => (
                    <div key={art.id} className="bg-white dark:bg-[#122238] border border-gray-150 dark:border-white/5 rounded-3xl p-6 space-y-2.5 shadow-sm hover:shadow transition-all">
                      ...
                      <h4 className="text-sm font-bold text-[#1D1D46] dark:text-white leading-normal hover:text-[#F0652E] cursor-pointer">{art.title}</h4>
              ...
              <div className="bg-white dark:bg-[#122238] border border-gray-150 dark:border-white/5 rounded-3xl p-6 space-y-4 shadow-sm">
                ...
                <div className="space-y-3 font-medium text-xs text-gray-600 dark:text-gray-300">
                  <div className="flex justify-between border-b border-gray-50 dark:border-white/5 pb-2">
                    ...
                    <span className="font-bold text-[#1D1D46] dark:text-white">{editExperienceYears} Years</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-50 dark:border-white/5 pb-2">
                    <span className="text-gray-400">Executive Level:</span>
                    <span className="font-bold text-[#1D1D46] dark:text-white">{editRoleLevel.split(" ")[0]}</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-50 dark:border-white/5 pb-2">
                    <span className="text-gray-400">Thought Columns:</span>
                    <span className="font-bold text-[#1D1D46] dark:text-white">{articles.length} Published</span>
                  </div>
                ...
                <div className="space-y-3.5">
                  {[
                    ...
                    <div key={idx} className="flex items-center justify-between text-xs border-b border-gray-50 dark:border-white/5 pb-2.5 last:border-none last:pb-0">
                      <div>
                        <h4 className="font-bold text-[#1D1D46] dark:text-white hover:underline cursor-pointer">{lead.name}</h4>
                ...
                <div className="space-y-3.5 text-xs">
                  {[
                    ...
                    <div key={idx} className="space-y-1 border-b border-gray-50 dark:border-white/5 pb-2.5 last:border-none last:pb-0">
                      <h4 className="font-bold text-[#1D1D46] dark:text-white hover:text-[#F0652E] cursor-pointer leading-snug">{news}</h4>
