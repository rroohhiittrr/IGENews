        ...
        <div className="bg-gradient-to-br from-[#1E3A5F] to-[#122238] rounded-3xl p-6 md:p-8 mb-8 border border-white/10 text-white relative overflow-hidden shadow-xl">
          ...
          <div className="relative z-10 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold tracking-widest text-[#F4A024] uppercase">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-3 border-t border-white/10 mt-2">
              ...
              <div className="bg-gradient-to-br from-[#C55A11]/15 to-[#F4A024]/15 rounded-xl p-3 border border-[#C55A11]/20">
                <h4 className="text-[10px] font-bold text-[#F4A024] uppercase tracking-wider mb-2 flex items-center gap-1.5">
      ...
      {step < 6 && (
        <div className="mb-8">
          <div className="flex justify-between items-center text-xs font-bold text-gray-400 mb-3">
            ...
            <span className="text-[#F4A024] uppercase tracking-wider">
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 2 && (
          <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <h2 className="text-xl font-bold text-[#1E3A5F] dark:text-white mb-1">Executive Identity</h2>
                  ...
                  {headshotBase64 ? (
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <button 
                        ...
                        className="px-3 py-1.5 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-[9px] font-bold rounded-xl flex items-center gap-1"
                      >
        ...
        {step === 3 && (
          <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <h2 className="text-xl font-bold text-[#1E3A5F] dark:text-white mb-1">Industry & Sector Alignment</h2>
            ...
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  ...
                  <button 
                    ...
                    className="px-4 py-2.5 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-xs font-bold rounded-xl"
                  >
                    Add
                  </button>
                </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-base font-black text-[#1E3A5F] dark:text-white px-3 py-1 bg-gray-100 dark:bg-white/5 rounded-lg">
                ...
                <input 
                  ...
                  className="w-full h-2 bg-gray-100 dark:bg-white/5 rounded-lg appearance-none cursor-pointer accent-[#1E3A5F] dark:accent-[#F4A024]"
                />
              </div>
        ...
        {step === 4 && (
          <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <h2 className="text-xl font-bold text-[#1E3A5F] dark:text-white mb-1">Professional Biography & Timeline</h2>
            ...
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <button type="button" onClick={addTimelineEntry} className="text-[#F4A024] text-[10px] font-bold">+ Add Entry</button>
                </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <button type="button" onClick={addEducationEntry} className="text-[#F4A024] text-[10px] font-bold">+ Add Institution</button>
                </div>
                <div className="space-y-3">
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <button type="button" onClick={addAchievement} className="text-[#F4A024] text-[10px] font-bold">+ Add Achievement</button>
                </div>
        ...
        {step === 5 && (
          <motion.div key="step5" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <h2 className="text-xl font-bold text-[#1E3A5F] dark:text-white mb-1">Company Linkage & Opinion Column</h2>
            ...
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
              ...
              <div className="flex items-center justify-between py-3 border-t border-gray-100 dark:border-white/5">
                <div>
                  <span className="text-xs font-bold text-[#1E3A5F] dark:text-white block">Opinion Column Publishing Interest</span>
        ...
        {step === 6 && (
          ...
          >
            ...
            <div className="space-y-2">
              <h2 className="text-2xl md:text-3xl font-bold text-[#1E3A5F] dark:text-white">Your Free Leader Profile is Live!</h2>
            ...
            <div className="bg-[#f4f7fb] dark:bg-white/5 p-5 rounded-2xl max-w-lg mx-auto border border-gray-100 dark:border-transparent text-left space-y-4">
              ...
              <div className="flex items-center justify-between border-b border-gray-200 dark:border-white/5 pb-2">
                ...
                <span className="text-[10px] font-extrabold text-[#F4A024] bg-orange-500/10 px-2 py-0.5 rounded uppercase">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    onClick={copyUrl}
                    className="px-3 py-2 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-[10px] font-bold rounded-lg flex items-center gap-1 shadow-sm shrink-0"
                  >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 max-w-lg mx-auto pt-3">
              <button 
                ...
                className="flex-1 py-3.5 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-xs font-bold rounded-xl shadow-lg transition-all text-center"
              >
              ...
              <button 
                ...
                className="px-5 py-3.5 bg-gray-100 hover:bg-gray-200 text-[#1E3A5F] dark:bg-white/5 dark:text-white dark:hover:bg-white/10 text-xs font-bold rounded-xl transition-all text-center"
              >
