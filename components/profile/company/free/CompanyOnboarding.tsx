      ...
      <AnimatePresence mode="wait">
        ...
        {step === 2 && (
          <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <h2 className="text-xl font-bold text-[#1E3A5F] dark:text-white mb-1">Company Identity</h2>
        ...
        {step === 3 && (
          <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <h2 className="text-xl font-bold text-[#1E3A5F] dark:text-white mb-1">Sector & Business Profile</h2>
        ...
        {step === 4 && (
          <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <h2 className="text-xl font-bold text-[#1E3A5F] dark:text-white mb-1">Corporate Brand Assets</h2>
                  ...
                  {logoBase64 ? (
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <button 
                        ...
                        className="px-4 py-2 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-[10px] font-bold rounded-xl flex items-center gap-1"
                      >
        ...
        {step === 5 && (
          <motion.div key="step5" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <h2 className="text-xl font-bold text-[#1E3A5F] dark:text-white mb-1">Team & Leadership (Optional)</h2>
            ...
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-xs font-bold text-[#1E3A5F] dark:text-white block">Do you have leaders you want to link?</span>
        ...
        {step === 6 && (
          ...
          >
            ...
            <div className="space-y-2">
              <h2 className="text-2xl md:text-3xl font-bold text-[#1E3A5F] dark:text-white">Your Free Company Profile is Live!</h2>
