          ...
          <div className="lg:col-span-9 space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1.5 text-left">
                    <div className="flex flex-wrap items-center gap-2">
                      <h1 className="text-xl font-bold text-[#1E3A5F] dark:text-white leading-tight">{editCompanyName}</h1>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm space-y-4 text-left">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-2xl font-black text-[#1E3A5F] dark:text-white">{editLeaderEmails.length} <span className="text-xs text-gray-400">/ 2 max</span></h4>
                  ...
                  <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm space-y-4 text-left">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-base font-bold text-[#1E3A5F] dark:text-white uppercase">{visibility} Page</h4>
                ...
                <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 shadow-sm text-left space-y-4">
                  <div className="flex items-center justify-between border-b border-gray-100 dark:border-white/5 pb-3">
                    <div>
                      <h3 className="font-bold text-[#1E3A5F] dark:text-white">Profile Views Analytics</h3>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-left">
                    <div className="p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                      ...
                      <span className="text-xl font-bold text-[#1E3A5F] dark:text-white">4</span>
                    </div>
                    <div className="p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                      <span className="text-[10px] font-bold text-gray-400 block mb-1">This Week</span>
                      <span className="text-xl font-bold text-[#1E3A5F] dark:text-white">29</span>
                    </div>
                    <div className="p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                ...
                <div className="bg-orange-500/5 border border-orange-500/15 rounded-3xl p-5 md:p-6 text-left flex gap-4">
                  ...
                  <div className="space-y-1.5">
                    <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white">Unverified Listing Notice</h4>
            ...
            {adminTab === "edit" && (
              <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-6 text-left">
                <div className="flex items-center justify-between border-b border-gray-100 dark:border-white/5 pb-3">
                  <div>
                    <h3 className="font-bold text-[#1E3A5F] dark:text-white">Edit Company Directory Details</h3>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mb-2">
                      ...
                      <button 
                        ...
                        className="px-4 py-2.5 bg-[#1E3A5F] text-white text-xs font-bold rounded-xl"
                      >
                        Add
                      </button>
                    </div>
            ...
            {adminTab === "leaders" && (
              <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-6 text-left">
                <div>
                  <h3 className="font-bold text-[#1E3A5F] dark:text-white">Linked Leadership Team</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                        ...
                        className="px-5 py-2.5 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-xs font-bold rounded-xl"
                      >
                        Send Invite
                      </button>
                    </div>
                  ...
                  {editLeaderEmails.map((email, idx) => {
                    ...
                    return (
                      <div key={email} className="p-4 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-150 dark:border-white/5 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-xl bg-[#1E3A5F]/5 dark:bg-white/5 flex items-center justify-center text-gray-400 shrink-0">
                            <User className="w-5 h-5" />
                          </div>
                          <div>
                            <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white">{email.split("@")[0].replace(".", " ")}</h4>
            ...
            {adminTab === "pr" && (
              <div className="relative bg-white dark:bg-[#122238] rounded-3xl p-8 border border-gray-100 dark:border-white/5 shadow-sm text-center overflow-hidden min-h-[350px] flex flex-col items-center justify-center space-y-5">
                ...
                <div className="space-y-2 max-w-md">
                  <h3 className="text-lg font-bold text-[#1E3A5F] dark:text-white">Press Releases Tab Locked</h3>
                ...
                <button onClick={() => setAdminTab("upgrade")} className="px-6 py-3 bg-gradient-to-r from-[#1E3A5F] to-[#2F6FA3] text-white text-xs font-bold rounded-xl shadow-md uppercase tracking-wider">
            ...
            {adminTab === "analytics" && (
              <div className="relative bg-white dark:bg-[#122238] rounded-3xl p-8 border border-gray-100 dark:border-white/5 shadow-sm text-center overflow-hidden min-h-[350px] flex flex-col items-center justify-center space-y-5">
                ...
                <div className="space-y-2 max-w-md">
                  <h3 className="text-lg font-bold text-[#1E3A5F] dark:text-white">B2B Analytics Locked</h3>
                  <p className="text-xs text-gray-400 leading-relaxed">
                ...
                <div className="bg-[#f4f7fb] dark:bg-white/5 p-4 rounded-2xl text-left text-[11px] text-gray-500 space-y-1.5 border border-gray-200 dark:border-transparent max-w-sm">
                  ...
                  <div className="flex justify-between font-mono">
                    ...
                    <span className="text-[#1E3A5F] dark:text-white font-bold">29 views</span>
                  </div>
                  <div className="flex justify-between font-mono">
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                  ...
                  <div className="bg-white dark:bg-[#122238] border-2 border-gray-150 dark:border-white/5 rounded-[32px] p-6 flex flex-col justify-between shadow-sm">
                    <div className="space-y-4">
                      <div>
                        ...
                        <h4 className="text-base font-bold text-[#1E3A5F] dark:text-white">FREE MEMBER</h4>
                  ...
                  <div className="bg-gradient-to-b from-[#1E3A5F]/5 to-transparent dark:from-[#1E3A5F]/20 dark:to-[#122238]/20 border-2 border-[#1E3A5F] dark:border-[#F4A024] rounded-[32px] p-6 flex flex-col justify-between shadow-lg relative overflow-hidden">
                    <div className="absolute top-3 right-3 bg-[#F4A024] text-white text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider">Best Value</div>
                    <div className="space-y-4">
                      <div>
                        <span className="text-[9px] font-bold text-[#F4A024] block uppercase">Verified brand page</span>
                        <h4 className="text-base font-bold text-[#1E3A5F] dark:text-white">SILVER PLAN</h4>
                        <div className="mt-2 flex items-baseline gap-1">
                          <span className="text-3xl font-black text-[#1E3A5F] dark:text-white">₹99,000</span>
                  ...
                  <div className="bg-white dark:bg-[#122238] border-2 border-gray-150 dark:border-white/5 rounded-[32px] p-6 flex flex-col justify-between shadow-sm">
                    <div className="space-y-4">
                      <div>
                        ...
                        <h4 className="text-base font-bold text-[#1E3A5F] dark:text-white">GOLD PLAN</h4>
                        <div className="mt-2 flex items-baseline gap-1">
                          <span className="text-3xl font-black text-[#1E3A5F] dark:text-white">₹3L - 10L</span>
                          <span className="text-[10px] text-gray-400">/ year</span>
                        </div>
                      </div>
                      <div className="h-px bg-gray-100 dark:bg-white/5 w-full" />
            ...
            {adminTab === "settings" && (
              <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 shadow-sm space-y-6 text-left">
                <div>
                  <h3 className="font-bold text-[#1E3A5F] dark:text-white">Company Administration Settings</h3>
                ...
                <div className="border-t border-gray-100 dark:border-white/5 pt-4">
                  <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white mb-3">Signatory Management</h4>
                    ...
                    <div className="bg-white dark:bg-[#122238] border border-gray-100 dark:border-white/10 rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl relative">
                      ...
                      {transferStep === 1 && (
                        <div className="space-y-3.5 text-left">
                          <h4 className="font-bold text-[#1E3A5F] dark:text-white">Transfer Representative Admin Rights</h4>
                          ...
                          <button onClick={handleStartTransfer} className="w-full py-2.5 bg-[#1E3A5F] text-white hover:bg-[#2F6FA3] text-xs font-bold rounded-xl shadow">Send Verification Code</button>
                        </div>
                      )}

                      {transferStep === 2 && (
                        <div className="space-y-3.5 text-left">
                          <h4 className="font-bold text-[#1E3A5F] dark:text-white">OTP Verification Check</h4>
                          ...
                          <input 
                            ...
                            placeholder="------"
                            className="w-full py-3 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-center font-mono text-xl tracking-widest text-[#1E3A5F] dark:text-white focus:outline-none"
                          />
                      ...
                      {transferStep === 3 && (
                        <div className="space-y-3.5 text-center">
                          ...
                          <h4 className="font-bold text-[#1E3A5F] dark:text-white">OTP Confirmed!</h4>
                          <p className="text-[11px] text-gray-400">
                            Ownership transferred to <strong>{newAdminName}</strong> ({newAdminEmail}).
                          </p>
                          <button onClick={handleConfirmTransferSubmit} className="w-full py-2.5 bg-[#1E3A5F] text-white text-xs font-bold rounded-xl">Complete and Refresh</button>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="border-t border-gray-100 dark:border-white/5 pt-4 flex items-center justify-between">
                  <div>
                    <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white">Public Directory Visibility</h4>
                ...
                {/* Notifications */}
                <div className="border-t border-gray-100 dark:border-white/5 pt-4 space-y-3">
                  <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white">Email Notification Preferences</h4>
                  <div className="space-y-2">
                    {[
                ...
                {/* Password reset */}
                <div className="border-t border-gray-100 dark:border-white/5 pt-4 space-y-3">
                  <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white">Update Signatory Account Password</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input 
                      type="password" 
                      value={newPassword}
                  ...
                  {newPassword && newPassword === confirmPassword && (
                    <button 
                      ...
                      className="px-4 py-1.5 bg-[#1E3A5F] text-white text-[10px] font-bold rounded-lg shadow-sm"
                    >
                      Update Password
                    </button>
                  )}
                  ...
                  {!deleteConfirmOpen ? (
                    ...
                    <div className="p-4 bg-red-500/5 border border-red-500/20 rounded-2xl space-y-3.5 max-w-md">
                      <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed">
                        ...
                        To confirm, type <strong className="text-[#1E3A5F] dark:text-white">{editCompanyName}</strong> below:
                      </p>
                      <input 
                        type="text" 
      ...
      {viewMode === "public" && (
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-[#122238] rounded-[32px] border border-gray-150 dark:border-white/5 overflow-hidden shadow-sm">
            ...
            <div className="h-44 bg-gradient-to-r from-[#1E3A5F] to-[#2F6FA3] dark:from-[#112238] dark:to-[#172c47] relative overflow-hidden">
              {editCoverBase64 && (
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 -mt-16 sm:-mt-20">
                ...
                <div className="flex-1 text-center sm:text-left space-y-2 pt-1.5">
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2.5">
                    <h1 className="text-2xl sm:text-3xl font-bold text-[#1E3A5F] dark:text-white leading-tight font-display">{editCompanyName}</h1>
                    <div 
                  ...
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-4 gap-y-1.5 text-xs text-gray-500 font-medium">
                    ...
                    <span className="flex items-center gap-1"><Star className="w-3.5 h-3.5 text-[#F4A024]" /> {editCompanyType}</span>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {publicTab === "about" && (
                <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-150 dark:border-white/5 text-left space-y-6 shadow-sm">
                  <div className="space-y-3">
                    <h3 className="text-sm font-bold text-[#1E3A5F] dark:text-white border-l-4 border-[#F4A024] pl-2.5">Business Overview</h3>
                    ...
                    return (
                      <div key={email} className="bg-white dark:bg-[#122238] border border-gray-150 dark:border-white/5 rounded-3xl p-5 md:p-6 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-2xl bg-[#1E3A5F]/5 dark:bg-white/5 flex items-center justify-center text-gray-400 font-bold shrink-0">
                            {name.charAt(0).toUpperCase()}
                          </div>
                          <div>
                            <h4 className="text-sm font-bold text-[#1E3A5F] dark:text-white capitalize">{name}</h4>
                ...
                <div className="space-y-4 text-left">
                  {getSectorNews().map((news, idx) => (
                    <div key={idx} className="bg-white dark:bg-[#122238] border border-gray-150 dark:border-white/5 rounded-3xl p-6 space-y-2.5 shadow-sm hover:shadow transition-all">
                      ...
                      <h4 className="text-sm font-bold text-[#1E3A5F] dark:text-white leading-normal hover:text-[#F4A024] cursor-pointer">{news.title}</h4>
            ...
            <div className="lg:col-span-4 space-y-6 text-left">
              ...
              <div className="bg-white dark:bg-[#122238] border border-gray-150 dark:border-white/5 rounded-3xl p-6 space-y-4 shadow-sm">
                ...
                <div className="space-y-3 font-medium text-xs text-gray-600 dark:text-gray-300">
                  <div className="flex justify-between border-b border-gray-50 dark:border-white/5 pb-2">
                    ...
                    <span className="font-bold text-[#1E3A5F] dark:text-white">Est. {editIncorporationYear || "N/A"}</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-50 dark:border-white/5 pb-2">
                    <span className="text-gray-400">Classification:</span>
                    <span className="font-bold text-[#1E3A5F] dark:text-white">{editBusinessType}</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-50 dark:border-white/5 pb-2">
                ...
                <div className="space-y-3.5">
                  {[
                    ...
                    <div key={idx} className="flex items-center justify-between text-xs border-b border-gray-50 dark:border-white/5 pb-2.5 last:border-none last:pb-0">
                      <div>
                        <h4 className="font-bold text-[#1E3A5F] dark:text-white hover:underline cursor-pointer">{comp.name}</h4>
              ...
              <div className="bg-gradient-to-br from-orange-500/10 to-[#F4A024]/10 border border-orange-500/20 rounded-3xl p-5 space-y-3">
