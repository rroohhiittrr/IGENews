  ...
  return (
    <div className="bg-white dark:bg-[#122238] rounded-[32px] p-6 md:p-8 border border-gray-100 dark:border-white/5 shadow-sm max-w-2xl mx-auto my-8">
      <div className="flex items-center gap-2.5 mb-4">
        ...
        <h2 className="text-xl font-bold text-[#1D1D46] dark:text-white">Your Free Reader Plan</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h4 className="text-xs font-bold text-[#1D1D46] dark:text-white uppercase tracking-wider mb-3">Included Features:</h4>
