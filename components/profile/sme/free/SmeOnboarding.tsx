...
export default function SmeOnboarding() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 pb-24 text-left">
      ...
      {step < 6 && (
        <div className="mb-8 p-6 bg-gradient-to-br from-[#1E3A5F]/5 to-[#2F6FA3]/10 border border-[#1E3A5F]/15 dark:border-white/5 rounded-3xl flex items-start gap-4">
          <Info className="w-6 h-6 text-[#C55A11] shrink-0 mt-0.5" />
          <div className="space-y-1">
            <h3 className="text-sm font-bold text-[#1E3A5F] dark:text-white uppercase tracking-wide">
            ...
            {[2, 3, 4, 5].map((s) => (
              <div 
                ...
                className={`h-full flex-1 rounded-full transition-all duration-300 ${
                  s <= step ? "bg-gradient-to-r from-[#1E3A5F] to-[#2F6FA3]" : "bg-gray-200 dark:bg-white/10"
                }`}
              />
            ))}
          </div>
      ...
      <div className="relative">
        ...
        {step === 2 && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-[#1E3A5F] dark:text-white font-display">Personal & Professional Identity</h2>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-xs text-gray-700 dark:text-white font-semibold border-none focus:outline-none focus:ring-1 focus:ring-[#1E3A5F]"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 bg-[#f4f7fb] dark:bg-white/5 rounded-lg text-xs text-gray-700 dark:text-white font-semibold border-none focus:outline-none focus:ring-1 focus:ring-[#1E3A5F]"
                    >
            ...
            <div className="flex justify-end items-center mt-8">
              <button 
                onClick={handleNext}
                className="px-8 py-3.5 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-xs font-bold rounded-xl flex items-center gap-1.5 shadow-md transition-colors"
              >
        ...
        {step === 3 && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-[#1E3A5F] dark:text-white">Experience & Expertise Declaration</h2>
            ...
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
              ...
              <div className="p-5 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-transparent">
                ...
                <input 
                  ...
                  className="w-full h-2 bg-gray-200 dark:bg-white/10 rounded-lg appearance-none cursor-pointer accent-[#1E3A5F] dark:accent-[#C55A11]"
                />
                {experienceYears < 20 && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full px-4 py-3 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-xs text-gray-700 dark:text-white font-semibold border-none focus:outline-none focus:ring-1 focus:ring-[#1E3A5F]"
                  >
                    {SECTORS.map((s) => (
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-3 text-xs font-bold rounded-xl border text-center transition-all ${
                          checked
                            ? "border-[#1E3A5F] dark:border-[#2F6FA3] bg-[#1E3A5F]/5 dark:bg-[#2F6FA3]/15 text-[#1E3A5F] dark:text-white"
                            : "border-gray-200 dark:border-white/5 bg-[#f4f7fb] dark:bg-white/5 text-gray-500 hover:border-gray-300"
                        }`}
                      >
                        <div className="flex items-center justify-center gap-1.5">
                          <div className={`w-3.5 h-3.5 rounded border flex items-center justify-center shrink-0 ${checked ? "bg-[#1E3A5F] dark:bg-[#2F6FA3] border-transparent" : "border-gray-400 bg-white"}`}>
            ...
            <div className="flex justify-between items-center mt-8">
              ...
              <button 
                ...
                className={`px-8 py-3.5 text-white text-xs font-bold rounded-xl flex items-center gap-1.5 shadow-md transition-colors ${experienceYears >= 20 ? "bg-[#1E3A5F] hover:bg-[#2F6FA3]" : "bg-gray-300 dark:bg-white/10 text-gray-400 cursor-not-allowed"}`}
              >
                Next Step <ArrowRight className="w-3.5 h-3.5" />
              </button>
            </div>
        ...
        {step === 4 && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-[#1E3A5F] dark:text-white">Professional Biography</h2>
            ...
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-3 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-xs text-gray-700 dark:text-white focus:outline-none resize-none border-none focus:ring-1 focus:ring-[#1E3A5F]"
                  ...
                  {milestones.map((m, idx) => (
                    <div key={idx} className="space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full px-4 py-3 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-xs text-gray-700 dark:text-white border-none focus:outline-none focus:ring-1 focus:ring-[#1E3A5F]"
        ...
        {step === 5 && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-[#1E3A5F] dark:text-white font-display">Content & Consulting Preferences</h2>
            ...
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-8 border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <input 
                    ...
                    className="flex-1 px-4 py-2.5 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-xs text-gray-700 dark:text-white border-none focus:outline-none focus:ring-1 focus:ring-[#1E3A5F]"
                    placeholder="Type country name and press Add (e.g. Germany, UAE)"
                  />
                  <button 
                    type="button" 
                    onClick={handleAddCountry} 
                    className="px-5 py-2.5 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-xs font-bold rounded-xl shadow transition-colors"
                  >
                    Add
                  </button>
                </div>
              ...
              <div className="pt-4 border-t border-gray-100 dark:border-white/5 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <span className="text-xs font-bold text-[#1E3A5F] dark:text-white block">Open to Consulting Inquiries</span>
                ...
                {consultingAvailable && (
                  ...
                  >
                    <div className="p-3.5 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/30 rounded-xl flex items-start gap-2 text-[10px] text-amber-700 dark:text-amber-400 leading-normal font-semibold">
                      <Star className="w-4 h-4 text-amber-500 shrink-0 mt-0.5 fill-[#F4A024]" />
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mb-2">
                        ...
                        />
                        <button type="button" onClick={handleAddConsultingArea} className="px-4 py-2 bg-[#1E3A5F] text-white text-xs font-bold rounded-lg">Add</button>
                      </div>
                      ...
                      <div className="flex gap-2">
                        {(["Online", "In-Person", "Both"] as const).map(mode => (
                          <button
                            ...
                            className={`px-3 py-1.5 text-xs font-bold rounded-lg border transition-all ${consultingMode === mode ? "bg-[#1E3A5F] border-[#1E3A5F] text-white" : "bg-white dark:bg-[#122238] border-gray-200 dark:border-white/5 text-gray-500"}`}
                          >
                            {mode}
                          </button>
                        ))}
              ...
              <div className="pt-4 border-t border-gray-100 dark:border-white/5 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <span className="text-xs font-bold text-[#1E3A5F] dark:text-white block">Interested in Article Publishing</span>
                ...
                {articleWritingInterest && (
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      ...
                      />
                      <button type="button" onClick={handleAddArticleTopic} className="px-4 py-2 bg-[#1E3A5F] text-white text-xs font-bold rounded-lg">Add</button>
                    </div>
                    <div className="flex flex-wrap gap-1.5">
                      {articleTopics.map((topic, idx) => (
                        <span key={idx} className="px-2 py-1 bg-[#1E3A5F]/5 dark:bg-white/5 text-[#1E3A5F] dark:text-gray-300 text-xs font-medium rounded border border-[#1E3A5F]/10 dark:border-transparent flex items-center gap-1">
                          {topic}
        ...
        {step === 6 && (
          <div className="bg-white dark:bg-[#122238] rounded-[32px] p-8 border border-gray-100 dark:border-white/5 shadow-2xl text-center space-y-6 animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl md:text-3xl font-bold text-[#1E3A5F] dark:text-white font-display">Your Free SME Profile is Live!</h2>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className="px-4 py-2 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-[10px] font-bold rounded-lg flex items-center gap-1 transition-colors"
                  >
            ...
            <div className="bg-gradient-to-br from-[#1E3A5F]/5 to-[#2F6FA3]/10 border border-[#1E3A5F]/15 dark:border-white/5 rounded-2xl max-w-md mx-auto p-5 text-left space-y-3.5">
              <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white uppercase tracking-wider flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-[#F4A024]" /> Compare Benefits & Unlock Blue Tick
              </h4>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 max-w-md mx-auto pt-2.5">
              <button 
                ...
                className="flex-1 py-3 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-xs font-bold rounded-xl shadow-lg transition-colors text-center"
              >
              ...
              <button 
                ...
                className="px-5 py-3 bg-gray-100 hover:bg-gray-200 text-[#1E3A5F] dark:bg-white/5 dark:text-white text-xs font-bold rounded-xl transition-colors text-center"
              >
