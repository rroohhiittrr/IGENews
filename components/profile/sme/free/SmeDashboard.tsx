            ...
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm space-y-4 relative overflow-hidden">
              ...
              <div className="space-y-2.5 text-xs text-gray-500">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-2 py-0.5 bg-[#1E3A5F]/10 dark:bg-white/5 text-[#1E3A5F] dark:text-white font-bold rounded text-[10px]">
                    {currentSectorName}
                  </span>
                </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {adminTab === "overview" && (
                <motion.div key="overview" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
                  <div className="border-b border-gray-100 dark:border-white/5 pb-4">
                    <h3 className="text-xl font-bold text-[#1E3A5F] dark:text-white">Profile Overview</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div className="p-5 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-transparent space-y-2 relative overflow-hidden">
                      ...
                      >
                        <span className="px-2.5 py-1 bg-[#1E3A5F] text-white text-[9px] font-bold rounded-lg shadow uppercase tracking-wide">
                  ...
                  <div className="p-5 bg-[#1E3A5F]/5 dark:bg-white/5 rounded-2xl border border-[#1E3A5F]/10 dark:border-transparent space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {profile.followSectors && profile.followSectors.map((sectorId: string) => {
                        ...
                        return (
                          <span key={sectorId} className="px-2.5 py-1 bg-white dark:bg-[#122238] border border-gray-200 dark:border-white/5 text-[#1E3A5F] dark:text-gray-300 rounded-lg text-xs font-semibold">
                            {sName}
                          </span>
                        );
                      })}
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full px-3.5 py-2.5 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-xs text-gray-700 dark:text-white border-none focus:outline-none focus:ring-1 focus:ring-[#1E3A5F]"
                        />
                      </div>
                          ...
                          {SECTORS.filter(s => s.id !== editPrimarySector).map(s => {
                            ...
                            return (
                              <button
                                ...
                                className={`px-2 py-1 text-[9px] font-bold rounded ${active ? "bg-[#1E3A5F] text-white" : "bg-white dark:bg-[#122238] text-gray-400 border border-gray-200 dark:border-white/5"}`}
                              >
                                {s.name}
                              </button>
                            );
                    ...
                    <div>
                      ...
                      <textarea 
                        ...
                        className="w-full px-3.5 py-2.5 bg-[#f4f7fb] dark:bg-white/5 rounded-xl text-xs text-gray-700 dark:text-white border-none focus:outline-none focus:ring-1 focus:ring-[#1E3A5F] resize-none"
                      />
                    </div>
              ...
              {adminTab === "articles" && (
                <motion.div key="articles" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
                  ...
                  <div className="border-b border-gray-100 dark:border-white/5 pb-4 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                    <div>
                      <h3 className="text-xl font-bold text-[#1E3A5F] dark:text-white">My Published Articles</h3>
              ...
              {adminTab === "consulting" && (
                <motion.div key="consulting" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
                  ...
                  <div className="border-b border-gray-100 dark:border-white/5 pb-4">
                    <h3 className="text-xl font-bold text-[#1E3A5F] dark:text-white">Consulting Inquiries</h3>
                  ...
                  <div className="p-5 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-transparent rounded-2xl space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="text-xs font-bold text-[#1E3A5F] dark:text-white block">Consulting Availability Status</span>
                  ...
                  <div className="bg-gradient-to-br from-[#1E3A5F]/5 to-[#2F6FA3]/10 border border-[#1E3A5F]/15 dark:border-white/5 rounded-3xl p-6 text-center space-y-4 max-w-lg mx-auto">
                    ...
                    <div className="space-y-2">
                      <h4 className="text-base font-bold text-[#1E3A5F] dark:text-white font-display">Unlock Direct Calendars & Consulting Earnings</h4>
              ...
              {adminTab === "upgrade" && (
                <motion.div key="upgrade" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
                  ...
                  <div className="border-b border-gray-100 dark:border-white/5 pb-4">
                    <h3 className="text-xl font-bold text-[#1E3A5F] dark:text-white">Compare SME Membership Plans</h3>
                    ...
                    <table className="w-full text-left border-collapse text-xs">
                      <thead>
                        <tr className="bg-gray-50 dark:bg-white/5 border-b border-gray-100 dark:border-white/5">
                          ...
                          <th className="p-4 font-bold text-[#1E3A5F] dark:text-white">PAID PRO PLAN</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-100 dark:divide-white/5">
                        ...
                        <tr>
                          ...
                          <td className="p-4 font-semibold text-[#1E3A5F] dark:text-white">Priority indexing boost</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="p-4 font-bold text-[#1E3A5F] dark:text-white">₹49,000 / year</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 -mt-20 md:-mt-24 pb-8 border-b border-gray-100 dark:border-white/5">
              ...
              <div className="flex-1 text-center md:text-left space-y-3 pt-4 md:pt-12">
                <div className="flex flex-col md:flex-row md:items-center justify-center md:justify-start gap-2.5">
                  ...
                  <h2 className="text-3xl font-extrabold text-[#1E3A5F] dark:text-white tracking-tight">
                    {profile.fullName || user.name}
                  </h2>
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-xs text-gray-500">
                  ...
                  <span className="flex items-center gap-1 text-[#1E3A5F] dark:text-white font-bold">
                ...
                <div className="bg-gray-50 dark:bg-white/5 p-5 border border-gray-100 dark:border-transparent rounded-3xl space-y-3">
                  ...
                  <div className="space-y-3.5 text-xs">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-[#1E3A5F] dark:text-gray-300 truncate max-w-[150px]">{currentSectorName}</span>
                    </div>
                ...
                <div className="bg-gray-50 dark:bg-white/5 p-5 border border-gray-100 dark:border-transparent rounded-3xl space-y-3.5">
                  ...
                  {contactSuccess ? (
                    ...
                    <form onSubmit={handleContactSubmit} className="space-y-3 text-xs">
                      ...
                      <button 
                        type="submit"
                        className="w-full py-2.5 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white font-bold rounded-xl transition-all shadow-sm flex items-center justify-center gap-1.5"
                      >
