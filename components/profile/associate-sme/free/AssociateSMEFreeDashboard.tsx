...
export default function AssociateSMEFreeDashboard() {
  ...
  const LOCKED_FEATURES = [
    { icon: FileText, label: "Article Publishing (Up to 4/month)", desc: "Share trade insights — available on ASME Pro" },
    { icon: BarChart3, label: "Readership Analytics & Performance", desc: "Track article reads, impressions, and reach" },
    { icon: Users, label: "Associate Directory Listing", desc: "Be discoverable by 50,000+ IGE Readers" },
    ...
    <div className="p-5 md:p-8 lg:p-10 max-w-5xl mx-auto pb-24">
      ...
      <div className="bg-slate-900 text-white rounded-2xl p-4 mb-6 shadow-lg flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-2 text-xs font-bold">
          ...
          <span className="text-slate-300">Associate SME Admin Dashboard (Free Tier)</span>
        </div>
      ...
      <div className="bg-white dark:bg-[#122238] rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden mb-8">
        ...
        <div className="px-6 pb-6">
          ...
          <button onClick={() => router.push(`/${locale}/profile/plans/associate-sme`)} className="w-full py-2.5 flex items-center justify-center gap-2 bg-[#1D1D46] hover:bg-[#F0652E] text-white text-xs font-bold rounded-xl transition-all">
            <ArrowRight className="w-3.5 h-3.5" /> Upgrade to ASME Pro — Unlock Articles & Directory Listing
          </button>
        </div>
      </div>
          ...
          <div className="bg-white dark:bg-[#122238] rounded-2xl p-5 border border-gray-100 dark:border-white/5 shadow-sm space-y-3">
            ...
            <div className="text-xs text-gray-500 space-y-2">
              <div className="flex justify-between py-1 border-b border-gray-50 dark:border-white/5">
                ...
                <span className="font-bold text-gray-700 dark:text-gray-300">Free ASME</span>
              </div>
              <div className="flex justify-between py-1 border-b border-gray-50 dark:border-white/5">
