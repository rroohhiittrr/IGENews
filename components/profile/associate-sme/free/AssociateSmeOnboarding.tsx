...
export default function AssociateSmeOnboarding() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 pb-24 text-left">
      ...
      {step < 6 && (
        <div className="mb-8 p-6 bg-gradient-to-br from-[#1E3A5F]/5 to-[#2F6FA3]/10 border border-[#1E3A5F]/15 dark:border-white/5 rounded-3xl space-y-4">
      ...
      <div className="relative">
        ...
        {step === 3 && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-[#1E3A5F] dark:text-white font-display">Experience & Sector Declaration</h2>
                ...
                {experienceYears > 20 && (
                  <div className="bg-amber-50/50 dark:bg-amber-950/10 border border-amber-200 dark:border-amber-900/30 rounded-2xl p-4 mt-4 space-y-2">
                    <p className="text-[11px] text-amber-700 dark:text-amber-400 font-bold leading-relaxed flex items-start gap-1">
                      <Sparkles className="w-4 h-4 text-[#F4A024] shrink-0 mt-0.5 animate-pulse" />
            ...
            <div className="flex justify-between items-center mt-8">
              ...
              <button 
                ...
                className={`px-8 py-3.5 text-white text-xs font-bold rounded-xl flex items-center gap-1.5 shadow-md transition-colors ${experienceYears >= 10 && experienceYears <= 20 ? "bg-[#1E3A5F] hover:bg-[#2F6FA3]" : "bg-gray-300 dark:bg-white/10 text-gray-400 cursor-not-allowed"}`}
              >
                Next Step <ArrowRight className="w-3.5 h-3.5" />
              </button>
            </div>
        ...
        {step === 4 && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-[#1E3A5F] dark:text-white font-display">Professional Biography</h2>
        ...
        {step === 5 && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-[#1E3A5F] dark:text-white font-display">Content & Affiliate Settings</h2>
        ...
        {step === 6 && (
          <div className="bg-white dark:bg-[#122238] rounded-[32px] p-8 border border-gray-100 dark:border-white/5 shadow-2xl text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl md:text-3xl font-bold text-[#1E3A5F] dark:text-white font-display">Your Free Associate SME Profile is Live!</h2>
