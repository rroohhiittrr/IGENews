...
export default function UpgradeJourneyCard({ user }: UpgradeJourneyCardProps) {
  return (
    <motion.div 
      ...
      className="bg-[#1E3A5F] rounded-[32px] p-8 shadow-xl text-white h-full flex flex-col relative overflow-hidden"
    >
      {/* Decorative background shape */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>

      <h2 className="text-xl font-medium mb-1 opacity-90">Individual Subscription</h2>
      <h3 className="text-2xl font-bold text-[#F4A024] mb-8">IGENews Premium</h3>
