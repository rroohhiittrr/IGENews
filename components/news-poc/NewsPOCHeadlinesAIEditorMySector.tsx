...
export default function NewsPOCHeadlinesAIEditorMySector({ onBack }: Props) {
  ...
  return (
    <div className="bg-gray-50 dark:bg-[#070b12] text-gray-900 dark:text-gray-100 min-h-screen pb-16 transition-colors duration-300">
      ...
      {/* ─── IGEN AI Editor Submenu Header Bar ─── */}
      <nav aria-label="IGEN AI Editor Submenu Navigation" className="mx-auto max-w-7xl px-4 pt-4 lg:px-6">
        <div className="flex items-center justify-between py-3 px-4 bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-xs flex-wrap gap-3">
          <div className="flex items-center gap-2">
            <Link href="/en/news-poc/headlines" className="p-1.5 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-500 hover:text-blue-600 transition-colors" title="Back to Headlines">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-3 py-1.5 rounded-lg flex items-center gap-1.5 shadow-xs">
              ...
              <span className="text-xs font-bold uppercase tracking-wider">IGEN AI Editor Submenu</span>
            </div>
            <span className="text-[11px] font-mono text-gray-400 hidden sm:inline">Automated AI producing real-time global news 24/7.</span>
          </div>
      ...
      <nav className="mx-auto max-w-7xl px-4 pt-3 lg:px-6 text-xs text-gray-400 font-semibold flex items-center gap-1.5">
        ...
        <Link href="/en/news-poc/headlines" className="hover:text-blue-500">Headlines</Link>
        <ChevronRight className="h-3 w-3" />
        <Link href="/en/news-poc/headlines/ai-editor/all" className="hover:text-blue-500">IGEN AI Editor</Link>
        <ChevronRight className="h-3 w-3" />
