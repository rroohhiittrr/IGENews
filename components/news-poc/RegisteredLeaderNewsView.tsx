        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 lg:px-6">
          <div className="max-w-3xl space-y-5">
            ...
            <div className="flex gap-3 flex-wrap pt-2">
              ...
              <Link
                href="/en/news-poc/leader-news/registered/pages"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section>
            <Card className="p-4 h-full space-y-3">
              ...
              <Link href="/en/news-poc/leader-news/registered/pages" className="block text-center text-[10px] font-bold text-blue-600 hover:underline pt-1">
