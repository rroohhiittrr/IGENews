            ...
            <div className="relative z-10 space-y-4 max-w-3xl">
              ...
              <div className="pt-2 flex items-center gap-4">
                <Link
                  ...
                  className="bg-[#1E3A5F] hover:bg-[#152e4f] text-white font-bold text-xs px-6 py-3 rounded-lg transition-all shadow-md inline-block tracking-wider"
                >
                  READ FULL ARTICLE
                </Link>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-12 lg:px-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 border-b border-gray-200 dark:border-gray-800 pb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="bg-[#1E3A5F] hover:bg-[#152e4f] text-white font-bold text-[10px] px-3.5 py-1.5 rounded-lg">
              Analytics
            </button>
            <Link 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
          ...
          <div className="bg-[#0f172a] text-white border border-gray-800 rounded-3xl p-6 flex flex-col justify-between shadow-xs">
            <div className="space-y-4">
              ...
              <div className="py-2">
                <span className="text-3xl font-bold text-[#F4A024]">Custom</span>
            ...
            <Link
              href="/eoi"
              className="w-full text-center bg-[#F4A024] hover:bg-[#C47F1A] text-gray-950 font-bold text-xs py-3 rounded-xl transition-colors mt-8"
            >
              Contact sales
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-12 rounded-2xl bg-gradient-to-br from-[#0c1424] to-[#162136] border border-slate-800 text-white p-6 md:p-8 flex flex-col justify-between">
            ...
            <div className="mt-8 border-t border-slate-800 pt-6">
              <Link
                href="/eoi"
                className="bg-[#F4A024] hover:bg-[#C47F1A] text-gray-950 font-bold text-xs px-6 py-3 rounded-lg transition-colors inline-block tracking-wider"
              >
                ACTIVATE AI PLUS
              </Link>
            </div>
