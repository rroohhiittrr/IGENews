    ...
    <div className="bg-gray-50 dark:bg-[#070b12] min-h-screen text-gray-900 dark:text-gray-100 pb-20">
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-6 pt-8 space-y-12">
        ...
        <section aria-labelledby="featured-sectors-heading">
          <SectionHeader title="Featured Sectors" cta="View All 50 Sectors" ctaHref="/en/news-poc/company-news/verified/all" />
            ...
            <div className="divide-y divide-gray-50 dark:divide-gray-850">
              {topCompanies.length > 0 ? topCompanies.map((co, i) => (
                ...
                <div className="px-5 py-8 text-center space-y-2">
                  ...
                  <Link href="/en/news-poc/company-news/verified/all" className={`${V.btn} font-bold text-xs px-4 py-2 rounded-lg inline-flex items-center gap-1`}>
          ...
          <section aria-labelledby="industry-dir-heading">
            ...
            <div className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden">
              ...
              <div className="p-3 border-t border-gray-100 dark:border-gray-850 text-center">
                <Link href="/en/news-poc/company-news/verified/all" className={`text-[10px] font-bold ${V.text} hover:underline flex items-center gap-0.5 justify-center`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <section aria-labelledby="sector-news-heading">
            <SectionHeader title="Latest Sector News" cta="View All Sector News" ctaHref="/en/news-poc/company-news/verified/news" />
          ...
          <section aria-labelledby="recommended-heading">
            ...
            <div className="space-y-3">
              ...
              <p className="text-[9px] text-gray-400 text-center">
                <Link href="/en/news-poc/company-news/verified/pages" className={`${V.text} font-bold hover:underline`}>Follow more companies</Link> to improve recommendations.
              </p>
            </div>
          </section>
        </div>
        ...
        <section aria-labelledby="intelligence-heading">
          <div className="bg-gradient-to-r from-slate-950 to-[#162d54] border border-slate-800 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="space-y-2 shrink-0">
              <Link href="/en/news-poc/sector-news/intelligence" className="block bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold text-sm px-7 py-3 rounded-xl text-center transition-all">
