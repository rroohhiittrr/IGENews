...
const RELATED_STORIES = [
  { type: "Industry News", title: "India Logistics Sector Sees 19% Growth in Verified Company Activity", publishedAt: "2 hrs ago", href: "/en/news-poc/sector-news/all" },
  { type: "Leader News", title: "CEOs of Verified Logistics Companies Discuss AI Adoption at Trade Summit", publishedAt: "1 day ago", href: "/en/news-poc/leader-news/verified/news" },
  { type: "Intelligence Report", title: "Verified Company News Trends: Q2 2026 Sector Analysis", publishedAt: "3 days ago", href: "/en/news-poc/sector-news/intelligence" },
];
    ...
    <div className="bg-gray-50 dark:bg-[#070b12] min-h-screen text-gray-900 dark:text-gray-100 pb-20">
      ...
      <nav aria-label="Breadcrumb" className="mx-auto max-w-7xl px-4 lg:px-6 py-3">
        <ol className="flex items-center gap-1.5 text-[10px] text-gray-400 flex-wrap">
          <li><Link href="/en/news-poc" className="hover:text-emerald-600 transition-colors">iGEN News</Link></li>
          <li><ChevronRight className="h-3 w-3" /></li>
          <li><Link href="/en/news-poc/company-news" className="hover:text-emerald-600 transition-colors">Company News</Link></li>
          <li><ChevronRight className="h-3 w-3" /></li>
          <li><Link href="/en/news-poc/company-news/verified/pages" className="hover:text-emerald-600 transition-colors">Verified Companies</Link></li>
          <li><ChevronRight className="h-3 w-3" /></li>
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-6 pt-8 space-y-12">
        ...
        <section aria-labelledby="by-industry-heading">
          <SectionHeader title="Company News by Industry" cta="Explore All Industries" ctaHref="/en/news-poc/sector-news/all" />
        ...
        <section aria-labelledby="by-country-heading">
          <SectionHeader title="Company News by Country" cta="Explore All Countries" ctaHref="/en/news-poc/country-news/all" />
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {COUNTRIES.map((c) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <section aria-labelledby="leadership-heading">
            <SectionHeader title="Leadership Moves" cta="Explore Leadership News" ctaHref="/en/news-poc/leader-news/verified/news" />
            <div className="space-y-3">
              ...
              <div className="text-center pt-2">
                <Link href="/en/news-poc/leader-news/verified/news" className="text-[10px] font-bold text-emerald-600 hover:underline flex items-center gap-0.5 justify-center">
