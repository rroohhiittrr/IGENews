            ...
            <div className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-xl p-4 shadow-xs space-y-2.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {ARTICLE_DATA.tags.sectors.map((s, idx) => (
                  <Link key={idx} href="/en/news-poc/sector-news" className="bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-300 text-xs font-bold px-2.5 py-1 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/60 transition-colors">
                    {s}
                  </Link>
                ))}
              </div>
            ...
            <div className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-xl p-4 shadow-xs space-y-2.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {ARTICLE_DATA.tags.industries.map((ind, idx) => (
                  <Link key={idx} href="/en/news-poc/feed/industry" className="bg-purple-50 dark:bg-purple-950/40 text-purple-600 dark:text-purple-300 text-xs font-bold px-2.5 py-1 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/60 transition-colors">
                    {ind}
                  </Link>
                ))}
              </div>
            ...
            <div className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-xl p-4 shadow-xs space-y-2.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {ARTICLE_DATA.tags.countries.map((c, idx) => (
                  <Link key={idx} href="/en/news-poc/country-news" className="bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-300 text-xs font-bold px-2.5 py-1 rounded-lg hover:bg-emerald-100 dark:hover:bg-emerald-900/60 transition-colors">
                    {c}
                  </Link>
                ))}
              </div>
            ...
            <div className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-xl p-4 shadow-xs space-y-2.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {ARTICLE_DATA.tags.leaders.map((l, idx) => (
                  <Link key={idx} href="/en/news-poc/leader-news" className="bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-300 text-xs font-bold px-2.5 py-1 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-900/60 transition-colors">
                    {l}
                  </Link>
                ))}
              </div>
            ...
            <div className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-xl p-4 shadow-xs space-y-2.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {ARTICLE_DATA.tags.readers.map((r, idx) => (
                  <Link key={idx} href="/en/news-poc/my-news" className="bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-300 text-xs font-bold px-2.5 py-1 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/60 transition-colors">
                    {r}
                  </Link>
                ))}
              </div>
            ...
            <div className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-xl p-4 shadow-xs space-y-2.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {ARTICLE_DATA.tags.general.map((tag, idx) => (
                  <Link key={idx} href="/en/news-poc/trending" className="bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-300 text-xs font-bold px-2.5 py-1 rounded-lg hover:bg-rose-100 dark:hover:bg-rose-900/60 transition-colors">
                    {tag}
                  </Link>
                ))}
              </div>
