                ...
                <div className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 p-5 rounded-2xl shadow-3xs space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <button 
                      ...
                      className="w-full bg-[#1E3A5F] hover:bg-[#152e4f] text-white text-[10px] font-bold py-2 rounded-lg transition-colors uppercase tracking-wider mt-1"
                    >
                ...
                <div className="border border-blue-200/50 dark:border-blue-900/40 bg-blue-50/10 dark:bg-blue-950/5 p-4 rounded-xl shadow-3xs space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className="flex-1 bg-[#1E3A5F] hover:bg-[#152e4f] text-white font-bold text-[10px] py-1.5 rounded-lg transition-colors text-center"
                    >
                      View Company
                    </button>
                  </div>
            ...
            {!enquirySuccess ? (
              <div className="space-y-4 text-xs">
                ...
                <button 
                  ...
                  className="w-full bg-[#1E3A5F] hover:bg-[#152e4f] text-white font-bold py-2.5 rounded-lg transition-colors uppercase text-xs"
                >
                  Send Enquiry
                </button>
              </div>
