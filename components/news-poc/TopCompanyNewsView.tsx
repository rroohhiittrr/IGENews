...
export default function TopCompanyNewsView() {
  ...
  const articleHref = (id: string) => `/en/news-poc/article/${id}`;
  ...
  const shareArticle = (id: string) => { if (typeof window !== "undefined" && navigator.clipboard) navigator.clipboard.writeText(`${window.location.origin}/en/news-poc/article/${id}`); };
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            ...
            <section className="space-y-3">
              ...
              <Link href="/en/news-poc/leader-news" className="text-[10px] text-amber-600 font-bold hover:underline inline-flex items-center gap-0.5">Explore Leadership News →</Link>
            </section>
            ...
            <section className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 p-5 rounded-2xl shadow-xs space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                {INDUSTRIES_LIST.map((ind) => (
                  <Link key={ind.id} href={`/en/news-poc/company-news/top/news?industry=${ind.id}`} className="flex justify-between items-center p-2 rounded-xl bg-gray-50 dark:bg-gray-955 hover:bg-amber-50/50 hover:text-amber-600 transition-all text-[10px]">
            ...
            <section className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 p-5 rounded-2xl shadow-xs space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                {COUNTRIES_LIST.map((c) => (
                  <Link key={c.code} href={`/en/news-poc/company-news/top/news?country=${c.code}`} className="flex justify-between items-center p-2 rounded-xl bg-gray-55 dark:bg-gray-955 hover:bg-amber-50/50 hover:text-amber-600 transition-all text-[10px]">
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <Link href={`/en/news-poc/company-news/top/news?industry=${industryNewsTab}`} className="text-[10px] text-amber-600 font-bold hover:underline block pt-1">View {ind?.name} Company News →</Link>
                </>
              );
            })()}
          </Card>
