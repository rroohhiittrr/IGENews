...
export default function RegisteredLeaderAllSectorsView() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-[#070b12] min-h-screen text-gray-900 dark:text-gray-100 pb-20">
      ...
      {/* ── 01. HERO SECTION ─────────────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-slate-900 via-indigo-950 to-blue-950 text-white relative overflow-hidden border-b border-gray-800">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 lg:px-6">
          <div className="max-w-3xl space-y-5">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-[10px] font-bold uppercase tracking-widest text-cyan-300 border border-cyan-800 px-3 py-1 rounded-full bg-cyan-950/40 inline-flex items-center gap-1.5 shadow-xs">
                <Compass className="h-3 w-3 text-cyan-300" /> ALL SECTORS
              </span>
              <span className="text-[10px] font-semibold text-white/80 bg-white/10 border border-white/20 px-2.5 py-0.5 rounded-full">
                Global Sector Directory & Leadership Gateway
              </span>
            </div>
            ...
            <p className="text-base text-white/85 leading-relaxed max-w-2xl font-normal">
              Discover sectors, industries, and leadership activity across the global business ecosystem.
            </p>
            ...
            <div className="flex gap-3 flex-wrap pt-2">
              <div className="relative flex-1 min-w-64">
                ...
                <input
                  ...
                  placeholder="Search sector, industry, leader or company (e.g. Technology, AI, Jensen Huang)..."
                  aria-label="Search sector, industry, leader or company"
                />
              </div>
              <button
                onClick={() => {
              ...
              <Link
                ...
                className="border border-white/30 bg-white/10 text-white font-bold text-sm px-5 py-3 rounded-xl hover:bg-white/20 transition-colors shrink-0 backdrop-blur-xs inline-flex items-center gap-1.5"
              >
                Discover Leaders →
              </Link>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 lg:px-6 space-y-12">
          ...
          <div className="lg:col-span-6 space-y-4">
            <Card className="p-5 h-full space-y-4">
              <SectionTitle
                ...
                subtitle="High-impact sectors with extensive corporate investments and executive governance."
                action={<Badge color="blue">EDITOR'S PICK</Badge>}
              />
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {featuredSectors.map((s) => (
                  <div
                    ...
                    className="p-3 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 hover:border-blue-300 transition-all cursor-pointer space-y-2"
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-[8px] font-bold bg-blue-50 text-blue-600 px-1.5 py-0.5 rounded">
                        {s.category}
                      </span>
                    ...
                    <div className="border-t border-gray-200/60 dark:border-gray-800 pt-2 flex items-center justify-between text-[9px] font-semibold text-blue-600">
                ...
                {trendingSectors.map((s) => (
                  ...
                  >
                    ...
                    <div className="text-right shrink-0">
                      <span className="text-[9px] text-blue-600 font-bold block">Preview Snapshot →</span>
        ...
        <section>
          <Card className="p-6 bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 text-white border-none space-y-5 shadow-lg">
            <div className="flex items-center justify-between flex-wrap gap-3 border-b border-white/15 pb-4">
              <div className="space-y-1">
                <span className="text-[9px] font-bold text-cyan-300 uppercase tracking-widest">Selected Sector Snapshot</span>
              ...
              <div className="flex gap-2">
                ...
                <Link
                  href="/en/news-poc/leader-news/registered/sector"
                  className="bg-white text-blue-950 font-bold text-xs px-5 py-2 rounded-xl hover:bg-blue-50 transition-colors inline-flex items-center gap-1.5 shadow-xs"
                >
            ...
            <div className="space-y-2">
              <span className="text-[10px] font-bold text-cyan-200 uppercase tracking-wider">Top Industries Inside This Sector:</span>
              <div className="flex flex-wrap gap-2">
                {activeSnapshotSector.topIndustries.map((ind) => (
                  ...
                  >
                    <span>{ind}</span>
                    <span className="text-[9px] text-cyan-300">Explore →</span>
                  </Link>
                ))}
              </div>
            </div>
              ...
              return (
                ...
                >
                  <div className="space-y-2.5">
                    <div className="flex items-center justify-between">
                      <Badge color={sector.status === "Featured" ? "blue" : sector.status === "Trending" ? "amber" : sector.status === "Emerging" ? "purple" : "indigo"}>
                    ...
                    <div className="grid grid-cols-3 gap-2 bg-gray-50 dark:bg-gray-900/60 p-2.5 rounded-xl border border-gray-100 dark:border-gray-800/80 text-center">
                      <div>
                        ...
                        <span className="text-xs font-bold text-blue-600">{sector.leaders}</span>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <span className="text-xs font-bold text-emerald-600">{sector.newsCount}</span>
                      </div>
                    </div>
                  ...
                  <div className="border-t border-gray-100 dark:border-gray-800 pt-3 flex items-center justify-between gap-2">
                    ...
                    <Link
                      href="/en/news-poc/leader-news/registered/sector"
                      className="text-[10px] font-bold text-gray-700 dark:text-gray-300 hover:text-blue-600 inline-flex items-center gap-0.5"
                    >
                      <span>Explore</span>
                ...
                <table className="w-full text-left text-xs border-collapse">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                    <tr>
                      ...
                      {comparedSectorObjects.map((s) => (
                        <td key={s.id} className="p-3 font-bold text-blue-600">{s.leaders} Leaders</td>
                      ))}
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      {comparedSectorObjects.map((s) => (
                        <td key={s.id} className="p-3 font-bold text-emerald-600">{s.newsCount} Stories</td>
                      ))}
                    </tr>
                    <tr>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {SECTOR_NEWS_SNIPPETS.map((item) => (
              <Card key={item.id} className="p-4 flex flex-col justify-between space-y-3 hover:shadow-md transition-shadow">
                <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6 bg-gradient-to-br from-indigo-900 to-blue-950 text-white border-none space-y-4 shadow-md flex flex-col justify-between">
            <div className="space-y-2">
              <span className="text-[9px] font-bold text-cyan-300 uppercase tracking-widest">Personalized Feeds</span>
          ...
          <Card className="p-5 h-full space-y-3">
            <SectionTitle title="Recommended Sectors For You" action={<Badge color="indigo">Personalized</Badge>} />
