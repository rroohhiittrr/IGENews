...
// ─── Local UI Primitives (Strictly Scoped to Top Leaders All Sectors) ───
...
// ─── Sector Taxonomy Master for Top Leaders ───────────────────────────────
...
const ALL_50_SECTORS: MasterSector[] = [
  {
    ...
    keyLeader: { name: "Jensen Huang", role: "CEO", company: "NVIDIA" },
  ...
  },
  {
    ...
    keyLeader: { name: "Dr. K. Sivan", role: "Former Chairman", company: "ISRO / Space Advisory" },
    region: "Asia"
  },
  {
    id: "agri-tech",
    ...
    keyLeader: { name: "Ramesh Chauhan", role: "Founder", company: "AgriRoots" },
    region: "Asia"
  },
  {
    id: "chem-spec",
    ...
    keyLeader: { name: "Sunil Duggal", role: "Director", company: "SRF Chemicals" },
    region: "Asia"
  },
  {
    id: "telecom-5g",
    ...
    keyLeader: { name: "Gopal Vittal", role: "CEO", company: "Bharti Airtel" },
    region: "Asia"
  },
  {
    id: "defense-aero",
...
export default function TopLeaderAllSectorsView() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-[#070b12] min-h-screen text-gray-900 dark:text-gray-100 pb-20">
      ...
      {/* ── 01. HERO SECTION ─────────────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-indigo-900 via-purple-950 to-slate-950 text-white relative overflow-hidden border-b border-purple-900/60">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 lg:px-6">
          <div className="max-w-3xl space-y-5">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-[10px] font-bold uppercase tracking-widest text-purple-300 border border-purple-500/40 px-3 py-1 rounded-full bg-purple-950/60 inline-flex items-center gap-1.5 shadow-xs">
                <Crown className="h-3.5 w-3.5 text-purple-400" /> ALL SECTORS • TOP LEADERS
              </span>
              <span className="text-[10px] font-semibold text-indigo-200 bg-indigo-900/30 border border-indigo-700/40 px-2.5 py-0.5 rounded-full">
                Global Sector Directory &amp; Top Leadership Gateway
              </span>
            </div>
            ...
            <p className="text-base text-indigo-100/85 leading-relaxed max-w-2xl font-normal">
              Discover the most influential executive leaders, chairpersons, and board members driving global industries with authenticated profiles.
            </p>
            ...
            <div className="flex gap-3 flex-wrap pt-2">
              <div className="relative flex-1 min-w-64">
                ...
                <input
                  ...
                  placeholder="Search sector, industry, top leader or corporation (e.g. Finance, Tech, Jensen Huang)..."
                  aria-label="Search sector, industry, top leader or corporation"
                />
              </div>
              <button
                onClick={() => {
              ...
              <Link
                ...
                className="border border-purple-400/40 bg-white/10 text-white font-bold text-sm px-5 py-3 rounded-xl hover:bg-white/20 transition-colors shrink-0 backdrop-blur-xs inline-flex items-center gap-1.5"
              >
            ...
            <div className="flex flex-wrap gap-6 pt-3 border-t border-white/15">
              {[
                ...
                <div key={s.label}>
                  ...
                  <div className="text-[10px] text-indigo-200/70 uppercase tracking-wider font-semibold">{s.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 lg:px-6 space-y-12">
          ...
          <div className="lg:col-span-6 space-y-4">
            <Card className="p-5 h-full space-y-4">
              <SectionTitle
                ...
                action={<Badge color="purple">TOP LEADERS SELECT</Badge>}
              />
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {featuredSectors.map((s) => (
                  <div
                    ...
                    className="p-3 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 hover:border-purple-300 transition-all cursor-pointer space-y-2"
                  >
                    ...
                    <div className="border-t border-gray-200/60 dark:border-gray-800 pt-2 flex items-center justify-between text-[9px] font-semibold text-purple-600">
                ...
                {trendingSectors.map((s) => (
                  ...
                  >
                    ...
                    <div className="text-right shrink-0">
                      <span className="text-[9px] text-purple-600 font-bold block">Preview Snapshot →</span>
        ...
        <section>
          <Card className="p-6 bg-gradient-to-r from-purple-950 via-indigo-950 to-slate-950 text-white border border-purple-800/40 space-y-5 shadow-lg">
            <div className="flex items-center justify-between flex-wrap gap-3 border-b border-white/15 pb-4">
              <div className="space-y-1">
                <span className="text-[9px] font-bold text-purple-300 uppercase tracking-widest">Selected Sector Snapshot</span>
              ...
              <div className="flex gap-2">
                ...
                <Link
                  href="/en/news-poc/leader-news/top/sector"
                  className="bg-white text-purple-950 font-bold text-xs px-5 py-2 rounded-xl hover:bg-purple-50 transition-colors inline-flex items-center gap-1.5 shadow-xs"
                >
            ...
            <div className="space-y-2">
              <span className="text-[10px] font-bold text-purple-200 uppercase tracking-wider">Top Industries Inside This Sector:</span>
              <div className="flex flex-wrap gap-2">
                {activeSnapshotSector.topIndustries.map((ind) => (
                  <Link
                    key={ind}
                    href="/en/news-poc/all-industry"
                  ...
                  >
                    <span>{ind}</span>
                    <span className="text-[9px] text-purple-300">Explore →</span>
                  </Link>
                ))}
              </div>
            </div>
              ...
              return (
                <Card
                  ...
                  className={`p-5 flex flex-col justify-between space-y-4 transition-all ${
                    isSelected
                      ? "ring-2 ring-purple-600 shadow-md border-transparent"
                      : "hover:border-purple-300 hover:shadow-xs"
                  }`}
                >
                  <div className="space-y-2.5">
                    <div className="flex items-center justify-between">
                      <Badge color={sector.status === "Featured" ? "purple" : sector.status === "Trending" ? "amber" : sector.status === "Emerging" ? "rose" : "indigo"}>
                    ...
                    <div className="grid grid-cols-3 gap-2 bg-gray-50 dark:bg-gray-900/60 p-2.5 rounded-xl border border-gray-100 dark:border-gray-800/80 text-center">
                      <div>
                        ...
                        <span className="text-xs font-bold text-purple-600">{sector.leaders}</span>
                      </div>
                      <div>
                  ...
                  <div className="border-t border-gray-100 dark:border-gray-800 pt-3 flex items-center justify-between gap-2">
                    ...
                    <Link
                      href="/en/news-poc/leader-news/top/sector"
                      className="text-[10px] font-bold text-gray-700 dark:text-gray-300 hover:text-purple-600 inline-flex items-center gap-0.5"
                    >
                      <span>Explore</span>
        ...
        {comparedSectorObjects.length > 1 && (
          <section className="space-y-4">
            <Card className="p-5 space-y-4 bg-gradient-to-br from-purple-50/40 via-white to-indigo-50/40 dark:from-purple-950/20 dark:via-[#0f172a] dark:to-indigo-950/20 border-purple-200 dark:border-purple-900">
              <SectionTitle
                ...
                <table className="w-full text-left text-xs border-collapse">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                    <tr>
                      ...
                      {comparedSectorObjects.map((s) => (
                        <td key={s.id} className="p-3 font-bold text-purple-600">{s.leaders} Leaders</td>
                      ))}
                    </tr>
                    <tr>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {SECTOR_NEWS_SNIPPETS.map((item) => (
              <Card key={item.id} className="p-4 flex flex-col justify-between space-y-3 hover:shadow-md hover:border-purple-300 transition-all">
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-[9px] text-gray-500">
                    <span className="font-bold text-purple-600">{item.sector}</span>
                    <span>{item.time}</span>
                  </div>
                ...
                <div className="border-t border-gray-100 dark:border-gray-800 pt-3 flex items-center justify-between text-[10px]">
                  <Link href="/eoi" className="font-bold text-purple-600 hover:underline">
                    Read Story →
                  </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6 bg-gradient-to-br from-indigo-900 via-purple-950 to-slate-950 text-white border-none space-y-4 shadow-md flex flex-col justify-between">
            <div className="space-y-2">
              <span className="text-[9px] font-bold text-purple-300 uppercase tracking-widest">Personalized Feeds</span>
          ...
          <Card className="p-5 h-full space-y-3">
            <SectionTitle title="Recommended Sectors For You" action={<Badge color="purple">Personalized</Badge>} />
            ...
            <div className="space-y-2.5">
              {emergingSectors.concat(featuredSectors.slice(0, 1)).slice(0, 2).map((s) => (
                <div key={s.id} className="p-3 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-center justify-between gap-3">
                  ...
                  <button
                    onClick={() => toggleFollow(s.id)}
                    className="text-[9px] font-bold text-purple-600 hover:underline shrink-0"
                  >
          ...
          <Card className="p-6 bg-gradient-to-br from-slate-900 via-purple-950 to-indigo-950 text-white border-none space-y-5 shadow-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/70 mt-1">Upgrade from Free Registered access to monitor historical industry shifts, boardroom dossiers, and AI-synthesized forecasts across all 50 sectors.</p>
              </div>
            </div>
