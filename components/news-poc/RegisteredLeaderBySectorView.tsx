...
// ─── Local UI primitives (strictly scoped to Registered Leaders By Sector) ───
...
export default function RegisteredLeaderBySectorView() {
            ...
            <div className="flex gap-3 flex-wrap pt-2">
              <div className="relative flex-1 min-w-64">
                ...
                <input
                  ...
                  placeholder="Search sector, leader, industry or expertise (e.g. Technology leaders, Healthcare CEOs)..."
              ...
              <button
                ...
                className={`px-3.5 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all shrink-0 flex items-center gap-1.5 ${
                  selectedSectorId === sec.id
                    ...
                    : "bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 hover:text-blue-600 hover:bg-gray-200 dark:hover:bg-gray-800"
                }`}
              >
                <span>{sec.name}</span>
      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 lg:px-6 space-y-12">
        ...
        <section>
          <SectionTitle
            ...
            action={<Badge color="indigo">Core Ecosystem</Badge>}
          />
              ...
              >
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[8px] font-bold uppercase tracking-wider text-blue-600 bg-blue-50 dark:bg-blue-950 px-2 py-0.5 rounded">
                      {sec.tag}
                    </span>
            ...
            <Card className="p-5 h-full space-y-4">
              ...
              <div className="space-y-3">
                {topLeadersList.map((lead, idx) => (
                  <div key={idx} className="p-3 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-center justify-between gap-3 hover:border-blue-300 transition-colors">
                    ...
                    <div className="text-right shrink-0">
                      <span className="font-display font-bold text-xs text-blue-600 block">{lead.score} / 100</span>
              ...
              <Link href="/en/news-poc/all-leaders" className="block text-center text-xs font-bold text-blue-600 hover:underline pt-2">
        ...
        <section>
          <SectionTitle
            ...
            action={
              <Link href="/en/news-poc/leader-news/registered/news" className="text-xs font-bold text-blue-600 hover:underline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {SECTOR_NEWS_FEED.map((news) => (
              <Card key={news.id} className="p-4 flex flex-col justify-between space-y-3 hover:shadow-md transition-shadow">
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-[9px] text-gray-500">
                    <span className="font-bold text-blue-600">{news.sector}</span>
                    <span>{news.time}</span>
                  </div>
                ...
                <div className="border-t border-gray-100 dark:border-gray-800 pt-3 flex items-center justify-between">
                  ...
                  <button onClick={() => alert("Story link copied to clipboard")} className="text-gray-400 hover:text-blue-600" aria-label="Share story">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section>
            <Card className="p-5 h-full space-y-4">
              <SectionTitle title="Recent Leadership Moves by Sector" action={<Briefcase className="h-4 w-4 text-blue-500" />} />
                  ...
                  <div key={idx} className="p-3 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-center justify-between gap-3">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[8px] bg-blue-50 text-blue-600 px-1.5 py-0.2 rounded font-bold">{m.sector}</span>
                      </div>
                      <p className="text-[10px] text-blue-600 font-semibold mt-0.5">{m.move} — {m.company}</p>
