                  ...
                  >
                    ...
                    <div className="flex-1 space-y-2 min-w-0">
                      ...
                      <div className="pt-3 border-t border-gray-100 dark:border-gray-800/80 flex items-center justify-between text-[10px] text-gray-400 font-semibold">
                        ...
                        <Link href={`/en/news-poc/article/${art.id}`} className="text-blue-600 font-bold hover:underline shrink-0">
                          Read Article →
                        </Link>
                      </div>
              ...
              <div className="md:col-span-7 bg-white dark:bg-[#0f172a] rounded-3xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm hover:border-blue-400 transition-all flex flex-col justify-between group">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between text-xs text-gray-400">
                    ...
                    <Link href={`/en/news-poc/article/${ALL_LEADER_ARTICLES[3].id}`} className="text-blue-600 font-bold hover:underline">
                      Read Article →
                    </Link>
                  </div>
                </div>
            ...
            {[
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (sub.key === "all") {
                    router.push("/en/news-poc/feed/leader/all");
                    return;
                  }
                  if (sub.key === "my") {
          ...
          <div className="lg:col-span-8 flex flex-col justify-between bg-slate-950 rounded-3xl overflow-hidden border border-slate-900 shadow-lg min-h-[460px] relative group">
            ...
            <div className="relative z-10 p-6 sm:p-8 space-y-4 mt-auto">
              ...
              <div className="pt-2 flex items-center justify-between border-t border-white/10 text-[11px] text-gray-400">
                ...
                <Link
                  href={`/en/news-poc/article/${ALL_LEADER_ARTICLES[0].id}`}
            ...
            {tickerArticles.map((story) => (
              ...
              >
                ...
                <div className="pt-2 border-t border-gray-200/60 dark:border-gray-800/80 flex items-center justify-between text-[10px] text-gray-400 font-semibold font-mono">
                  ...
                  <Link href={`/en/news-poc/article/${story.id}`} className="text-blue-600 font-bold hover:underline">
                    Read →
                  </Link>
                </div>
              </div>
              ...
              {ALL_LEADER_ARTICLES
                ...
                .map((art) => (
                  <div key={art.id} className="p-4 bg-gray-50 dark:bg-gray-900/40 rounded-2xl border border-gray-200 dark:border-gray-800 space-y-2">
                    ...
                    <Link href={`/en/news-poc/article/${art.id}`} className="text-[10px] text-blue-600 font-bold hover:underline block pt-1">
      ...
      <section className="mx-auto max-w-7xl px-4 pt-12 lg:px-6">
        <div className="bg-white dark:bg-[#0f172a] rounded-3xl border border-gray-200 dark:border-gray-800 p-8 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Leadership Intelligence", desc: "Go deeper into individual leaders.", path: "/en/news-poc/leader-news/intelligence" },
              { title: "Leader Profiles", desc: "Explore detailed professional leader profiles.", path: "/en/news-poc/leader-news" },
              { title: "Company Intelligence", desc: "Understand the companies leaders operate.", path: "/en/news-poc/company-news" },
              { title: "Industry Intelligence", desc: "Understand the industries leaders influence.", path: "/en/news-poc/sector-news/industry" },
              { title: "Country Intelligence", desc: "Understand the countries where leaders operate.", path: "/en/news-poc/country-news/intelligence" },
              { title: "Premium Reports", desc: "Access deeper research and analysis.", path: "/en/news-poc/headlines" }
            ].map((prod) => (
              <div 
                key={prod.title}
