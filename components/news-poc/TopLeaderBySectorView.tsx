      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 lg:px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6" id="top-sector-leaders-section">
          ...
          <div className="lg:col-span-6 space-y-4">
            <Card className="p-5 h-full space-y-4">
              ...
              <Link href="/en/news-poc/all-leaders" className="block text-center text-xs font-bold text-purple-600 hover:underline pt-2">
        ...
        <section>
          <SectionTitle
            ...
            action={
              <Link href="/en/news-poc/leader-news/top/news" className="text-xs font-bold text-purple-600 hover:underline">
