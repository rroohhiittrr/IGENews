          ...
          <div className="relative z-10 space-y-4 max-w-4xl">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-6 border-t border-white/10 pt-4 text-xs font-semibold text-slate-300">
              ...
              <div className="ml-auto">
                <Link href={`/en/news-poc/article/${FEATURED_COMPANY_STORY.id}`} className="bg-amber-500 hover:bg-amber-600 text-gray-955 font-bold px-5 py-2.5 rounded-lg transition-colors flex items-center gap-1.5 text-[10px]">
