...
export default function LeaderAllCommunityView() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const storedFollows = localStorage.getItem("igen_followed_leaders");
      const storedConnections = localStorage.getItem("igen_connected_leaders");
      const storedEvents = localStorage.getItem("igen_registered_events");
  ...
  const handleFollowLeader = (id: string) => {
    ...
    localStorage.setItem("igen_followed_leaders", JSON.stringify(updated));
  };
  ...
  const handleConnectLeader = (id: string) => {
    ...
    localStorage.setItem("igen_connected_leaders", JSON.stringify(updated));
  };
  ...
  const handleRegisterEvent = (id: string) => {
    ...
    localStorage.setItem("igen_registered_events", JSON.stringify(updated));
  };
      ...
      <main id="directory-browser" className="mx-auto max-w-7xl px-4 py-8 lg:px-6 space-y-10">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="pt-4 mt-4 border-t border-gray-150 dark:border-gray-855 flex items-center justify-between gap-2">
                        ...
                        <Link
                          href={`/en/news-poc/leader-news/pages/featured`}
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-[#0f172a] border border-gray-250 dark:border-gray-800 rounded-2xl p-5 space-y-4">
            ...
            <div className="space-y-3">
              {[
                { title: "Bilateral Silicon Testing Corridor Regulations", count: 23, path: "/en/news-poc/communities/leader/top" },
                { title: "Smart Port Container Freight Telemetry APIs", count: 17, path: "/en/news-poc/communities/leader/top" },
                { title: "ESG Financing Standards & Unified Criteria", count: 12, path: "/en/news-poc/communities/leader/top" }
              ].map((disc, idx) => (
