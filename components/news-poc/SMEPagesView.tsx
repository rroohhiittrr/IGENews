      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 lg:px-6 space-y-12">
        ...
        <section id="sme-section-sector">
          <SectionTitle
            ...
            action={<Link href="/en/news-poc/all-sector-directory" className="text-[10px] font-bold text-blue-600 hover:underline">All 50 Sectors →</Link>}
          />
        ...
        <section id="sme-section-industry">
          <SectionTitle
            ...
            action={<Link href="/en/news-poc/all-industry" className="text-[10px] font-bold text-blue-600 hover:underline">All Industries →</Link>}
          />
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {INDUSTRIES.map((ind) => (
              <Card key={ind.name} className="p-3 hover:border-blue-300 hover:shadow-xs transition-all">
                ...
                <Link href="/en/news-poc/all-industry" className="text-[8px] font-bold text-gray-400 hover:text-blue-600 mt-1.5 block">View Directory →</Link>
              </Card>
            ))}
          </div>
        </section>
        ...
        <section id="sme-section-country">
          <SectionTitle
            ...
            action={<Link href="/en/news-poc/all-country" className="text-[10px] font-bold text-blue-600 hover:underline">All Countries →</Link>}
          />
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {COUNTRIES.map((c) => (
              <Card key={c.name} className="p-3 text-center hover:border-blue-300 hover:shadow-xs transition-all cursor-pointer">
                ...
                <Link href="/en/news-poc/all-country" className="text-[8px] font-bold text-blue-600 hover:underline mt-1 block">View →</Link>
              </Card>
            ))}
          </div>
        </section>
