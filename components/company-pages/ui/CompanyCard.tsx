    ...
    >
      <div className="flex justify-between items-start gap-3">
        <div className="flex gap-4 items-center">
          ...
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#1E3A5F] to-[#2F6FA3] flex items-center justify-center text-white font-bold text-lg shrink-0 shadow-md">
          ...
          <div>
            ...
            <h3 className="font-bold text-base text-[#1E3A5F] dark:text-white group-hover:text-[#F4A024] transition-colors leading-tight line-clamp-1">
              {company.name}
            </h3>
          </div>
        </div>
      ...
      {/* Hover slide overlay */}
      <div className="absolute right-4 bottom-4 w-7 h-7 rounded-full bg-gray-50 dark:bg-white/5 group-hover:bg-[#1E3A5F] group-hover:text-white flex items-center justify-center text-gray-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
