  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="text-xs font-bold text-gray-600 dark:text-gray-200 bg-white dark:bg-[#122238] border border-gray-100 dark:border-white/5 px-3 py-2 rounded-xl focus:outline-none focus:ring-1 focus:ring-[#F0652E] cursor-pointer"
      >
