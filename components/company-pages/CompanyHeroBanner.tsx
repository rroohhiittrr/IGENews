...
export function CompanyHeroBanner() {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-[#1D1D46] to-[#0c1829] text-white py-16 md:py-24 px-4 lg:px-6">
      {/* Decorative backdrop grid */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff03_1px,transparent_1px),linear-gradient(to_bottom,#ffffff03_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none" />
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#F0652E]/10 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-7xl mx-auto text-center space-y-6 md:space-y-8 relative z-10">
        <div className="space-y-3 max-w-3xl mx-auto">
          <span className="text-[10px] font-black uppercase tracking-widest text-[#F0652E] bg-[#F0652E]/10 border border-[#F0652E]/20 px-3 py-1 rounded-full">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tight leading-tight" style={{ fontFamily: 'var(--font-display)' }}>
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F0652E] to-[#f97316]">Company Directory</span>
          </h1>
        ...
        <form onSubmit={handleSearchSubmit} className="max-w-2xl mx-auto">
          <div className="relative flex items-center p-2 rounded-2xl bg-white/10 backdrop-blur-md border border-white/10 shadow-2xl focus-within:ring-2 focus-within:ring-[#F0652E] focus-within:border-transparent transition-all">
            ...
            <button
              type="submit"
              className="bg-[#F0652E] hover:bg-[#d97706] text-white px-6 py-3.5 rounded-xl font-bold text-xs md:text-sm shrink-0 transition-colors shadow-md cursor-pointer"
            >
              Search
            </button>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
          <Link
            href={`/${locale}/eoi`}
            className="flex items-center gap-1.5 bg-white text-[#1D1D46] hover:bg-gray-100 px-5 py-3 rounded-2xl font-bold text-xs shadow-md transition-colors"
          >
          ...
          <Link
            href={`/${locale}/eoi`}
            className="flex items-center gap-1.5 bg-[#F0652E]/20 hover:bg-[#F0652E]/30 border border-[#F0652E]/40 text-white px-5 py-3 rounded-2xl font-bold text-xs transition-colors"
          >
        ...
        <div className="grid grid-cols-3 max-w-lg mx-auto bg-white/5 border border-white/5 backdrop-blur-md rounded-2xl p-4 divide-x divide-white/5 text-center text-xs">
          <div>
            <span className="block text-base md:text-lg font-black text-[#F0652E]">12,000+</span>
