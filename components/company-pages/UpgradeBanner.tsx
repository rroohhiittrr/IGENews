...
export function UpgradeBanner() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 lg:px-6 py-12">
      <div className="bg-gradient-to-r from-[#1D1D46] to-[#0642BA] dark:from-[#122238] dark:to-[#172c47] rounded-[32px] overflow-hidden text-white border border-white/5 shadow-xl relative p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff03_1px,transparent_1px),linear-gradient(to_bottom,#ffffff03_1px,transparent_1px)] bg-[size:20px_20px] pointer-events-none" />
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-96 h-96 bg-[#F0652E]/10 rounded-full blur-3xl pointer-events-none" />

        <div className="space-y-4 max-w-2xl text-center md:text-left relative z-10">
          <span className="text-[9px] font-black uppercase tracking-widest text-[#F0652E] bg-[#F0652E]/15 border border-[#F0652E]/30 px-3 py-1 rounded-full inline-flex items-center gap-1">
            <Sparkles className="w-3 h-3 fill-[#F0652E] stroke-none animate-pulse" />
            Grow Authority
          </span>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0 relative z-10 w-full md:w-auto">
          <Link
            ...
            className="flex items-center justify-center gap-1.5 bg-[#F0652E] hover:bg-[#d97706] text-white px-6 py-4 rounded-2xl font-bold text-xs shadow-md transition-colors w-full sm:w-auto"
          >
            Upgrade Plan
