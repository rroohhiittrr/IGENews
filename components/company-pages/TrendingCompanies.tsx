  ...
  return (
    <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 border border-gray-100 dark:border-white/5 space-y-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
      ...
      <div className="space-y-1">
        <span className="text-[9px] font-black uppercase tracking-wider text-[#F4A024] flex items-center gap-1">
            ...
            return (
              ...
              >
                ...
                <span className={`w-6 h-6 rounded-lg flex items-center justify-center text-xs font-black shrink-0 ${
                  rank === 1 ? 'bg-[#F4A024]/10 text-[#F4A024] border border-[#F4A024]/20' : 
                  rank === 2 ? 'bg-[#1E3A5F]/10 text-[#1E3A5F] dark:bg-white/5 dark:text-white' : 
                  'text-gray-400'
                }`}>
                  {rank}
                </span>
                ...
                <div className="min-w-0 flex-1">
                  <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white group-hover:text-[#F4A024] transition-colors leading-snug line-clamp-1">
                    {c.name}
                  </h4>
      ...
      <Link
        ...
        className="block text-center text-[10px] font-black uppercase text-[#F4A024] hover:text-[#1E3A5F] dark:hover:text-white transition-colors cursor-pointer"
      >
