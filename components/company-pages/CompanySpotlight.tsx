...
export function CompanySpotlight() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 lg:px-6 py-12">
      <div className="bg-gradient-to-br from-[#1E3A5F] to-[#0c1829] rounded-[32px] overflow-hidden text-white border border-[#2F6FA3]/30 shadow-2xl relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-[#F4A024]/10 via-transparent to-transparent pointer-events-none" />
        
        <div className="p-6 md:p-10 space-y-6 md:space-y-8 relative z-10">
          {/* Badge & header */}
          <div className="flex flex-wrap items-center justify-between gap-4">
            <span className="text-[10px] font-black uppercase tracking-widest text-[#F4A024] bg-[#F4A024]/15 border border-[#F4A024]/30 px-3.5 py-1.5 rounded-full flex items-center gap-1.5 shadow-md">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:items-center">
            {/* Logo initials mock */}
            <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-[#F4A024] to-[#e68a00] text-white font-extrabold text-3xl flex items-center justify-center shadow-lg border-2 border-white/20 shrink-0">
              {detail.logoInitials}
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-white/5 rounded-2xl p-5 border border-white/5">
            <div>
              ...
              <span className="text-base font-black text-[#F4A024]">{detail.foundedYear}</span>
            </div>
            <div>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Link
              ...
              className="flex items-center gap-1.5 bg-[#F4A024] hover:bg-[#d97706] text-white px-5 py-3.5 rounded-2xl font-bold text-xs transition-colors shadow-md"
            >
