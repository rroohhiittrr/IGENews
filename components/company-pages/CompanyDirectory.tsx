          ...
          {loading ? (
            ...
            <div className="text-center py-20 bg-white dark:bg-[#122238] border border-gray-100 dark:border-white/5 rounded-[32px] p-6">
              ...
              <button
                ...
                className="mt-4 px-5 py-2.5 bg-[#1D1D46] hover:bg-[#0642BA] text-white font-bold text-xs rounded-xl shadow-md cursor-pointer transition-colors"
              >
          ...
          <div className="relative w-80 bg-white dark:bg-[#122238] h-full p-6 shadow-2xl overflow-y-auto flex flex-col justify-between border-l border-gray-100 dark:border-white/10">
            <div>
              <div className="flex justify-between items-center mb-6">
                <span className="text-sm font-black text-[#1D1D46] dark:text-white uppercase tracking-wider">Search Filters</span>
                <button
            ...
            <button
              onClick={() => setMobileFilterOpen(false)}
              className="mt-6 w-full py-3.5 bg-[#1D1D46] text-white text-center font-bold text-xs rounded-2xl cursor-pointer"
            >
