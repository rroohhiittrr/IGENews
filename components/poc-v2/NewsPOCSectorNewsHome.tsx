        ...
        <div className="relative z-10 border-t border-white/10 bg-white/5 backdrop-blur-xs">
          <div className="mx-auto max-w-7xl px-4 lg:px-6 py-3 flex flex-wrap gap-2 items-center justify-between">
            ...
            <div className="flex gap-2 flex-wrap text-xs">
              {[
                { label: "All Sector Directory", href: "/en/poc-v2/sector-news/all", badge: "50 Sectors" },
                { label: "Sector Engagement", href: "/en/poc-v2/sector-news/engagement", badge: "Community" },
                { label: "Sector Intelligence", href: "/en/poc-v2/sector-news/intelligence", badge: "Reports & AI" }
              ].map((sub, idx) => (
          ...
          <div className="relative z-10 space-y-4 max-w-4xl">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-6 border-t border-white/10 pt-4 text-xs font-semibold text-slate-300">
              ...
              <div className="ml-auto flex items-center gap-2 flex-wrap">
                <Link href={`/en/poc-v2/article/${FEATURED_SECTOR_STORY.id}`} className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-5 py-2.5 rounded-lg transition-colors flex items-center gap-1.5 text-[10px]">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-10">
            ...
            <div className="space-y-4 bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-xs">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-2">
                ...
                <Link href={`/en/poc-v2/article/${LATEST_SECTOR_NEWS[0].id}`} className="lg:col-span-6 flex flex-col gap-4 group cursor-pointer block">
                ...
                <div className="lg:col-span-6 divide-y divide-gray-100 dark:divide-gray-855 space-y-4 lg:pl-4">
                  {LATEST_SECTOR_NEWS.slice(1).map((item, idx) => (
                    <Link key={item.id} href={`/en/poc-v2/article/${item.id}`} className={`hover:bg-gray-55 dark:hover:bg-gray-955 transition-colors group p-3.5 rounded-xl cursor-pointer block ${idx > 0 ? "pt-4" : ""}`}>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-10 lg:px-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-3">
            ...
            <Link href="/en/poc-v2/sector-news/all" className="text-[10px] font-bold text-blue-500 hover:underline uppercase">View Master Directory</Link>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-10 pb-6 lg:px-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-3">
            ...
            <Link href="/en/poc-v2/sector-news/intelligence" className="text-[10px] font-bold text-blue-500 hover:underline uppercase">View All Reports</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
