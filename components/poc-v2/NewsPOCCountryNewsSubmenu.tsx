...
export default function NewsPOCCountryNewsSubmenu({ submenu }: Props) {
  ...
  const basePath = "/en/poc-v2/country-news";
  ...
  if (submenu === "my") {
    return (
      <div className="bg-gray-50 dark:bg-[#070b12] min-h-screen text-gray-900 dark:text-gray-100 pb-16">
        <SubMenuHeader />
        {/* Complete content & structure from Feed -> Country Feed -> My Country sub view */}
        <NewsPOCAllCountryFeedView />
        <div className="my-8 border-t border-gray-200 dark:border-gray-800" />
        {/* Existing complete content & structure from Country News -> My Country */}
