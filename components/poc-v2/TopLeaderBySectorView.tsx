...
// ─── Local UI primitives (strictly scoped to Top Leaders By Sector) ───
...
function Badge({ children, color = "purple" }: { children: React.ReactNode; color?: string }) {
  ...
  return (
    <span className={`text-[8px] font-bold px-2 py-0.5 rounded-full inline-flex items-center gap-1 ${map[color] ?? map.purple}`}>{children}</span>
  );
}

// ─── Mock Data for By Sector Hub ─────────────────────────────────────────────
...
const SECTORS_MASTER: SectorItem[] = [
  {
    ...
    leaderCount: "540 Leaders",
    industryCount: "28 Industries",
    newsCount: "142 Stories",
    tag: "FEATURED",
    tagColor: "purple",
  ...
  },
  {
    ...
    leaderCount: "480 Leaders",
    industryCount: "22 Industries",
    newsCount: "118 Stories",
    tag: "TRENDING",
    tagColor: "indigo",
  ...
  },
  {
    ...
    leaderCount: "390 Leaders",
    industryCount: "19 Industries",
    newsCount: "96 Stories",
    tag: "EDITOR'S PICK",
    tagColor: "amber",
  ...
  },
  {
    ...
    leaderCount: "310 Leaders",
    industryCount: "16 Industries",
    newsCount: "84 Stories",
    tag: "FEATURED",
    tagColor: "purple",
  ...
  },
  {
    ...
    leaderCount: "280 Leaders",
    industryCount: "14 Industries",
    newsCount: "78 Stories",
    tag: "TRENDING",
    tagColor: "indigo",
...
const TOP_LEADERS_BY_SECTOR: Record<string, { name: string; role: string; company: string; score: number; flag: string; photo: string }[]> = {
  tech: [
    { name: "Jensen Huang", role: "CEO", company: "NVIDIA Corp", score: 97, flag: "🇺🇸", photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&auto=format&fit=crop&q=80" },
    ...
    { name: "Nandan Nilekani", role: "Chairman", company: "Infosys", score: 93, flag: "🇮🇳", photo: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&auto=format&fit=crop&q=80" }
  ],
  finance: [
    { name: "Ananya Sengupta", role: "MD South Asia", company: "Standard Chartered", score: 92, flag: "🇮🇳", photo: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=200&auto=format&fit=crop&q=80" },
  ...
  energy: [
    { name: "Mukesh Ambani", role: "Chairman", company: "Reliance Industries", score: 96, flag: "🇮🇳", photo: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&auto=format&fit=crop&q=80" },
    { name: "Dr. Rajesh Grover", role: "CTO", company: "Adani Green", score: 89, flag: "🇮🇳", photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&auto=format&fit=crop&q=80" },
    { name: "Marcus Vance", role: "MD APAC", company: "Nordic Clean Tech", score: 87, flag: "🇩🇪", photo: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=80" }
  ]
};

const SECTOR_RANKINGS_DATA: Record<string, { rank: number; name: string; role: string; company: string; score: number; change: string }[]> = {
  tech: [
    { rank: 1, name: "Jensen Huang", role: "CEO", company: "NVIDIA Corp", score: 97, change: "▲ +2" },
    { rank: 2, name: "N. Chandrasekaran", role: "Chairman", company: "Tata Sons", score: 98, change: "▲ 0" },
  ...
  finance: [
    { rank: 1, name: "Sheikh Tahnoon bin Zayed", role: "Chairman", company: "ADQ / G42", score: 95, change: "▲ +1" },
    { rank: 2, name: "Ananya Sengupta", role: "MD", company: "Standard Chartered", score: 92, change: "▲ +3" },
    { rank: 3, name: "Pooja Malhotra", role: "CFO", company: "PayPulse", score: 91, change: "▲ +2" },
    { rank: 4, name: "Bill Winters", role: "Group CEO", company: "Standard Chartered", score: 90, change: "▲ 0" },
  ],
  energy: [
    { rank: 1, name: "Mukesh Ambani", role: "Chairman", company: "Reliance Industries", score: 96, change: "▲ 0" },
    { rank: 2, name: "Dr. Rajesh Grover", role: "CTO", company: "Adani Green", score: 89, change: "▲ +4" },
    { rank: 3, name: "Marcus Vance", role: "MD", company: "Nordic Clean Tech", score: 87, change: "▲ +1" },
...
const SECTOR_NEWS_FEED = [
  {
    ...
    headline: "NVIDIA and Tata Sons Expand Sovereign AI GPU Supercomputing Grid in Hyderabad",
  ...
  },
  {
    ...
    headline: "Standard Chartered Deploys $2B Cross-Border Sustainable Liquidity Window for Asian Exporters",
...
const SECTOR_LEADERSHIP_MOVES = [
  ...
  { sector: "Manufacturing", leader: "Suresh Narayanan", move: "Transitioned to Senior Board Advisor", company: "Nestlé South Asia", date: "Effective Last Week" }
];
...
export default function TopLeaderBySectorView() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-[#070b12] min-h-screen text-gray-900 dark:text-gray-100 pb-20">
      ...
      {/* ── 01. HERO SECTION ─────────────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-purple-800 via-indigo-900 to-slate-950 text-white relative overflow-hidden">
          ...
          <div className="max-w-3xl space-y-5">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-[10px] font-bold uppercase tracking-widest text-white/80 border border-white/20 px-3 py-1 rounded-full bg-white/10 inline-flex items-center gap-1.5 shadow-xs">
                <Crown className="h-3.5 w-3.5 text-purple-300" /> BY SECTOR • TOP LEADERS
              </span>
              <span className="text-[10px] font-semibold text-purple-200 bg-purple-950/40 border border-purple-800/50 px-2.5 py-0.5 rounded-full">
                Top Sector Leadership Discovery Hub
              </span>
            </div>
            <h1 className="font-display text-3xl md:text-5xl font-bold tracking-tight leading-tight">
              Explore Top Leaders Across Every Sector
            </h1>
            <p className="text-base text-white/85 leading-relaxed max-w-2xl font-normal">
              Discover leading, emerging, and highly influential executive figures, leadership trends, and exclusive news across business sectors.
            </p>
            ...
            <div className="flex gap-3 flex-wrap pt-2">
              <div className="relative flex-1 min-w-64">
                ...
                <input
                  ...
                  placeholder="Search sector, leader, industry or expertise (e.g. Technology leaders, Finance CEOs)..."
                  aria-label="Search sector, leader, industry or expertise"
                />
              </div>
              <button
                onClick={() => {
                ...
                className="bg-white text-purple-900 font-bold text-sm px-6 py-3 rounded-xl hover:bg-purple-50 transition-colors shrink-0 shadow-sm"
              >
                Explore Sectors →
              </button>
              <button
            ...
            <div className="flex flex-wrap gap-6 pt-3 border-t border-white/15">
              {[
                ...
                { label: "Executive Leaders", value: "2,800+ Profiles" },
                { label: "Mapped Industries", value: "1,350+ Verticals" },
                { label: "Sector News Stories", value: "1,450+ Indexed" },
              ].map((s) => (
                <div key={s.label}>
                  <div className="text-xl font-bold tracking-tight text-white">{s.value}</div>
                  <div className="text-[10px] text-purple-200/70 uppercase tracking-wider font-semibold">{s.label}</div>
                </div>
              ))}
            </div>
          </div>
              ...
              <button
                ...
                className={`px-3.5 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all shrink-0 flex items-center gap-1.5 ${
                  selectedSectorId === sec.id
                    ...
                    : "bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 hover:text-purple-600 hover:bg-gray-200 dark:hover:bg-gray-800"
                }`}
              >
                <span>{sec.name}</span>
      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 lg:px-6 space-y-12">
        ...
        <section>
          <SectionTitle
            ...
            action={<Badge color="purple">Core Ecosystem</Badge>}
          />
              ...
              <Card
                ...
                className={`p-5 flex flex-col justify-between space-y-3 cursor-pointer transition-all ${
                  selectedSectorId === sec.id
                    ...
                    : "hover:border-purple-300 hover:shadow-xs"
                }`}
              >
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[8px] font-bold uppercase tracking-wider text-purple-600 bg-purple-50 dark:bg-purple-950 px-2 py-0.5 rounded">
                      {sec.tag}
                    </span>
                  ...
                  <p className="text-[10px] text-gray-500">
                    Featured Leader: <strong className="text-gray-800 dark:text-gray-200">{sec.featuredLeader}</strong> ({sec.featuredRole})
                  </p>
                  <div className="flex flex-wrap gap-1 pt-1">
                    {sec.topIndustries.slice(0, 3).map((ind) => (
                      <span key={ind} className="text-[8px] bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 px-1.5 py-0.5 rounded">
                        {ind}
                      </span>
                    ))}
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6" id="top-sector-leaders-section">
          ...
          <div className="lg:col-span-6 space-y-4">
            <Card className="p-5 h-full space-y-4">
              <SectionTitle
                title={`Top Leaders in ${currentSector.name}`}
              ...
              <div className="space-y-3">
                {topLeadersList.map((lead, idx) => (
                  <div key={idx} className="p-3 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-center justify-between gap-3 hover:border-purple-300 transition-colors">
                    ...
                    <div className="text-right shrink-0">
                      <span className="font-display font-bold text-xs text-purple-600 block">{lead.score} / 100</span>
              ...
              <Link href="/en/poc-v2/all-leaders" className="block text-center text-xs font-bold text-purple-600 hover:underline pt-2">
          ...
          <div className="lg:col-span-6 space-y-4">
            <Card className="p-5 h-full space-y-4">
              <SectionTitle
                title={`${currentSector.name} Rankings`}
                ...
                {rankingsList.map((item) => (
                  <div key={item.rank} className="py-2.5 flex items-center justify-between gap-3 text-xs">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-display font-bold text-purple-600">{item.score} pts</span>
                      <Link href="/eoi" className="text-[9px] font-bold text-purple-600 hover:underline">
                        Profile →
                      </Link>
                    </div>
              ...
              <div className="bg-purple-50/60 dark:bg-purple-950/20 p-3 rounded-xl border border-purple-100 dark:border-purple-900/40 text-[9px] text-gray-600 dark:text-gray-400 space-y-1">
                <span className="font-bold text-purple-600 uppercase tracking-wider block">Ranking Methodology:</span>
                <p>
        ...
        <section>
          <SectionTitle
            title="Latest Leadership News by Sector"
            subtitle="Executive appointments, strategic pivots, and corporate statements in the active sector."
            action={
              <Link href="/en/poc-v2/leader-news/top/news" className="text-xs font-bold text-purple-600 hover:underline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {SECTOR_NEWS_FEED.map((news) => (
              <Card key={news.id} className="p-4 flex flex-col justify-between space-y-3 hover:shadow-md hover:border-purple-300 transition-all">
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-[9px] text-gray-500">
                    <span className="font-bold text-purple-600">{news.sector}</span>
                    <span>{news.time}</span>
                  </div>
                  <h3 className="font-display text-sm font-bold text-gray-950 dark:text-white leading-snug hover:text-purple-600 cursor-pointer">
                    {news.headline}
                  </h3>
                ...
                <div className="border-t border-gray-100 dark:border-gray-800 pt-3 flex items-center justify-between">
                  ...
                  <button onClick={() => alert("Story link copied to clipboard")} className="text-gray-400 hover:text-purple-600" aria-label="Share story">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section>
            <Card className="p-5 h-full space-y-4">
              <SectionTitle title="Recent Leadership Moves by Sector" action={<Briefcase className="h-4 w-4 text-purple-500" />} />
                ...
                {SECTOR_LEADERSHIP_MOVES.map((m, idx) => (
                  <div key={idx} className="p-3 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="text-[10px] text-purple-600 font-semibold mt-0.5">{m.move} — {m.company}</p>
          ...
          <div className="space-y-1.5 pt-1">
            {currentSector.topIndustries.map((ind) => (
              <div key={ind} className="p-2 bg-gray-50 dark:bg-gray-900 rounded-lg text-[10px] font-semibold text-gray-700 dark:text-gray-300 border border-gray-100 dark:border-gray-800 flex items-center justify-between">
                <span>{ind}</span>
                <Link href="/en/poc-v2/all-industry" className="text-[8px] font-bold text-purple-600 hover:underline">Directory →</Link>
              </div>
            ))}
          </div>
        </Card>
        ...
        <Card className="p-5 space-y-3">
          <SectionTitle title="Recommended Sector Leaders" action={<Badge color="purple">Personalized</Badge>} />
          ...
          <div className="space-y-2.5">
            {topLeadersList.slice(0, 2).map((l, idx) => (
              <div key={idx} className="p-3 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-center justify-between gap-3">
                ...
                <Link href="/eoi" className="bg-purple-600 hover:bg-purple-700 text-white text-[9px] font-bold px-3 py-1.5 rounded-lg transition-colors shrink-0">
                  Connect →
                </Link>
              </div>
            ))}
        ...
        <section>
          <Card className="p-6 bg-gradient-to-br from-slate-900 via-purple-950 to-indigo-950 text-white border-none space-y-5 shadow-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h2 className="text-sm font-bold">Unlock Sector Leadership Intelligence</h2>
                <p className="text-[10px] text-white/70 mt-1">Upgrade your free tier to track predictive executive movement signals and boardroom dossiers across all 50 sectors.</p>
              </div>
            </div>
            ...
            <Link href="/eoi" className="block w-full text-center bg-purple-600 hover:bg-purple-700 text-white font-bold text-sm py-3 rounded-xl transition-colors shadow-xs">
              Unlock Premium Sector Intelligence →
            </Link>
          </Card>
        </section>
        ...
        <section>
          <Card className="p-6 bg-gradient-to-br from-purple-700 to-indigo-800 text-white border-none space-y-4 shadow-md">
            <div className="flex items-center gap-3">
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              />
              <button
                className="bg-white text-purple-900 font-bold text-sm px-6 py-2.5 rounded-xl hover:bg-purple-50 transition-colors shrink-0 shadow-xs"
