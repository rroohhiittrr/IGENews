...
export default function TopCompanyAllSectorsView() {
  ...
  const sectorHref = (code: string) => `/${locale}/poc-v2/company-news/top/sector?sector=${code}`;
  const companyHref = (id: string) => `/${locale}/poc-v2/company-news/top/pages/${id}`;
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 pt-4 space-y-8">
        ...
        <section className="space-y-4">
          <SectionTitle
            ...
            action={<Link href="/en/poc-v2/company-news/top/pages" onClick={() => track("top_company_all_sectors_company_click")} className="text-[10px] font-bold text-amber-600 hover:underline">Explore Sector Leaders →</Link>}
          />
            ...
            {SECTOR_NEWS.map((news) => {
              ...
              return (
                <div key={news.id} className="flex items-start gap-3 border border-gray-200 dark:border-gray-800 rounded-xl p-3 hover:bg-gray-50 dark:hover:bg-gray-900/30 transition-all">
                  ...
                  <Link href="/en/poc-v2/company-news/top/news" onClick={() => track("top_company_all_sectors_news_click", { sector: news.sectorCode })} className="text-[9px] font-bold text-amber-600 hover:underline shrink-0">Read →</Link>
                </div>
              );
            })}
          </div>
          <div className="text-center">
            <Link href="/en/poc-v2/company-news/top/news" onClick={() => track("top_company_all_sectors_news_click")} className="text-[10px] font-bold text-amber-600 hover:underline inline-flex items-center gap-1">View Sector News <ArrowRight className="h-3 w-3" /></Link>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-gradient-to-r from-indigo-900 via-purple-900 to-violet-900 rounded-2xl p-6 md:p-8 text-white border border-indigo-800/50 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-5">
              ...
              <Link href="/en/poc-v2/sector-news/industry" onClick={() => track("top_company_all_sectors_intelligence_click")} className="bg-white text-purple-900 hover:bg-purple-50 font-bold text-xs px-6 py-3 rounded-xl transition-all inline-flex items-center gap-2 shrink-0">
        ...
        <section className="space-y-4">
          ...
          <Card className="p-5 space-y-4">
            ...
            <Link
              href={`/${locale}/poc-v2/company-news/top/sector?sector=${businessSector}&country=${activityCountry}`}
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {COUNTRIES.map((c) => (
              <Card key={c.code} className="p-4 text-center space-y-2 hover:border-amber-500 transition-all">
                ...
                <Link href={`/${locale}/poc-v2/company-news/top/sector?country=${c.code}`} onClick={() => track("top_company_all_sectors_country_click", { country: c.code })} className="text-[8.5px] font-bold text-amber-600 hover:underline inline-flex items-center gap-0.5">
