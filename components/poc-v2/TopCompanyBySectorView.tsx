      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 pt-4 space-y-8">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            ...
            <section className="space-y-3">
              ...
              <div className="text-right"><Link href={`/en/poc-v2/company-news/top/all?sector=${sector.id}`} className="text-[10px] text-amber-600 font-bold hover:underline">View Full Ranking →</Link></div>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {SECTOR_NEWS.slice(0, 3).map((n) => (
                  <Card key={n.id} className="p-4 space-y-3 border-t-2 border-amber-500 hover:shadow-md transition-all">
                    ...
                    <Link href="/en/poc-v2/company-news/top/news" className="text-[9px] font-bold text-amber-600 hover:underline inline-flex items-center">View Sector News →</Link>
                  </Card>
                ))}
              </div>
            </section>
            ...
            <section className="bg-gradient-to-br from-amber-500 via-orange-600 to-[#b45309] text-white rounded-3xl p-6 md:p-8 border border-amber-400/40 space-y-4">
              ...
              <Link href="/en/poc-v2/industry-intelligence" className="inline-flex items-center gap-1 text-xs font-bold bg-white text-gray-950 px-5 py-2.5 rounded-xl hover:bg-gray-100 transition-colors">Explore Industry Intelligence →</Link>
            </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {BUSINESS_TYPES.map((bt) => (
              <Card key={bt.key} className="p-4 space-y-2 hover:border-amber-400 transition-all">
                ...
                <Link href={`/en/poc-v2/company-news/top/all?sector=${selectedSector}&type=${bt.key}`} className="text-[9px] font-bold text-amber-600 hover:underline inline-flex items-center">Explore →</Link>
              </Card>
            ))}
          </div>
        </section>
        ...
        <section className="bg-gradient-to-br from-amber-500 via-orange-600 to-[#b45309] text-white rounded-3xl p-6 md:p-8 border border-amber-400/40 space-y-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link href={`/en/poc-v2/company-news/top/all?sector=${selectedSector}&country=${countrySectorCode}`} className="bg-white text-gray-950 font-bold text-xs px-6 py-2.5 rounded-lg text-center hover:bg-gray-100 transition-colors">Top Companies →</Link>
          </div>
        </section>
