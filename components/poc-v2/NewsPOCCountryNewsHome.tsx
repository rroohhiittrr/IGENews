        ...
        <div className="relative z-10 border-t border-white/10 bg-white/5 backdrop-blur-xs">
          <div className="mx-auto max-w-7xl px-4 lg:px-6 py-3 flex flex-wrap gap-2 items-center justify-between">
            ...
            <div className="flex gap-2 flex-wrap text-xs">
              {[
                { label: "My Country Dashboard", href: "/en/poc-v2/country-news/my", badge: "Personalized" },
                { label: "All Countries (195 Bilateral)", href: "/en/poc-v2/country-news/all", badge: "Global Directory" }
              ].map((sub, idx) => (
          ...
          <div className="col-span-12 lg:col-span-8 space-y-10">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-3">
                ...
                <Link href="/en/poc-v2/country-news/all" className="text-[10px] font-bold text-blue-500 hover:underline uppercase">View All 195 Bilateral Corridors</Link>
              </div>
                ...
                {FDI_PROJECTS.map((proj, idx) => (
                  <div key={idx} className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-xl p-4 shadow-xs space-y-3 flex flex-col justify-between">
                    <div className="space-y-1.5">
                      <Link href="/en/poc-v2/sector-news" className="inline-block hover:opacity-85">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-3">
                ...
                <Link href="/en/poc-v2/country-news/all" className="text-[10px] font-bold text-blue-500 hover:underline uppercase">View All 195 Countries</Link>
              </div>
