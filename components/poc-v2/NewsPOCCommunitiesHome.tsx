...
const CORE_COMMUNITY_TRACKS = [
  {
    ...
    href: "/en/poc-v2/communities/sme"
  },
  {
    id: "reader",
    ...
    href: "/en/poc-v2/communities/reader"
  },
  {
    id: "leader",
    ...
    href: "/en/poc-v2/communities/leader"
  },
  {
    id: "expo",
    ...
    href: "/en/poc-v2/communities/expo"
  }
];
        ...
        <div className="relative z-10 border-t border-white/10 bg-white/5 backdrop-blur-xs">
          <div className="mx-auto max-w-7xl px-4 lg:px-6 py-3 flex flex-wrap gap-2 items-center justify-between">
            ...
            <div className="flex gap-2 flex-wrap text-xs">
              {[
                { label: "SME & ASME Network", href: "/en/poc-v2/communities/sme", badge: "Verified Experts" },
                { label: "Reader Community", href: "/en/poc-v2/communities/reader", badge: "Gamified Feed" },
                { label: "C-Suite Leader Club", href: "/en/poc-v2/communities/leader", badge: "Executive Roundtables" },
                { label: "IGEN Expo Network", href: "/en/poc-v2/communities/expo", badge: "Importers / Exporters" }
              ].map((sub, idx) => (
          ...
          <div className="col-span-12 lg:col-span-8 space-y-10">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-3">
                ...
                <Link href="/en/poc-v2/communities/expo" className="text-[10px] font-bold text-amber-500 hover:underline uppercase">View Expo Hub</Link>
              </div>
