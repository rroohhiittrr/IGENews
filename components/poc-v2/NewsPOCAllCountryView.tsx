            ...
            {GLOBAL_COUNTRIES_DB.slice(0, 4).map((c) => (
              ...
              >
                ...
                <div className="pt-3 mt-4 border-t border-gray-100 dark:border-gray-855 flex justify-between items-center text-[9px] font-bold">
                  ...
                  <Link href={`/en/poc-v2/country-news/my`} className="text-blue-605 hover:underline">
                    Explore Dashboard →
                  </Link>
                </div>
              </div>
              ...
              {getFilteredCountries().map((c) => (
                ...
                >
                  ...
                  <div className="pt-3 mt-4 border-t border-gray-100 dark:border-gray-855 flex justify-between items-center text-[9px] font-bold">
                    ...
                    <Link href={`/en/poc-v2/country-news/my`} className="text-blue-600 hover:underline">
                      View Profile
                    </Link>
                  </div>
                </div>
                  ...
                  {getFilteredCountries().map((c) => (
                    <tr key={c.code} className="hover:bg-gray-50 dark:hover:bg-gray-955 transition-colors">
                      ...
                      <td className="p-3 text-right space-x-2">
                        ...
                        <Link href={`/en/poc-v2/country-news/my`} className="text-[9.5px] font-extrabold text-blue-600 hover:underline">
                          View
                        </Link>
                      </td>
                    </tr>
