          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 text-xs">
                <Link href="/en/poc-v2" className="text-gray-500 hover:text-blue-600">Home</Link>
                {breadcrumbSource && breadcrumbSource.length > 0 ? (
                  ...
                  <>
                    <span className="text-gray-400">/</span>
                    <Link href="/en/poc-v2/feed" className="text-gray-500 hover:text-blue-600">Feed</Link>
                  </>
                )}
                <span className="text-gray-400">/</span>
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
                  <div className="space-y-1.5">
                    ...
                    <Link href={`/en/poc-v2/article/${story.id}`}>
                  ...
                  <div className="pt-2 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between text-xs">
                    ...
                    <Link href={`/en/poc-v2/article/${story.id}`} className="text-xs font-bold text-blue-600 hover:underline flex items-center gap-0.5">
                      Read Story →
                    </Link>
                  </div>
                </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-12 lg:px-6">
        <div className="bg-white dark:bg-[#0f172a] rounded-3xl border border-gray-200 dark:border-gray-800 p-8 shadow-xs space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/en/poc-v2/feed/industry/all" className="text-xs font-bold text-blue-600 hover:underline">
              All 50 Sectors →
            </Link>
          </div>
