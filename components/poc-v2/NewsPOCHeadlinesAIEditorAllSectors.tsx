  ...
  return (
    <div className="bg-gray-50 dark:bg-[#070b12] text-gray-900 dark:text-gray-100 min-h-screen pb-16 transition-colors duration-300">
      ...
      <nav aria-label="IGEN AI Editor Submenu Navigation" className="mx-auto max-w-7xl px-4 pt-4 lg:px-6">
        <div className="flex items-center justify-between py-3 px-4 bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-xs flex-wrap gap-3">
          ...
          <div className="flex items-center gap-1.5 bg-gray-100 dark:bg-gray-900 p-1 rounded-xl border border-gray-200 dark:border-gray-800">
            <Link
              href="/en/poc-v2/headlines/ai-editor/my"
            ...
            <Link
              href="/en/poc-v2/headlines/ai-editor/all"
      ...
      <nav className="mx-auto max-w-7xl px-4 pt-3 lg:px-6 text-xs text-gray-400 font-semibold flex items-center gap-1.5">
        ...
        <Link href="/en/poc-v2/headlines/ai-editor/all" className="hover:text-blue-500">IGEN AI Editor</Link>
        <ChevronRight className="h-3 w-3" />
                  ...
                  <div key={story.id} className="relative rounded-3xl overflow-hidden bg-slate-900 text-white min-h-[280px] flex flex-col justify-end p-6 border border-slate-900 shadow-sm group">
                    ...
                    <div className="relative z-10 space-y-2 max-w-xl font-sans">
                      ...
                      <div className="flex items-center gap-3 pt-2">
                        <Link 
                          href={`/en/poc-v2/article/${story.id}`}
                  ...
                  <div className="space-y-3 text-xs font-semibold">
                    {[
                      ...
                      <div key={idx} className="flex justify-between items-center text-[10px]">
                        ...
                        <Link href={`/en/poc-v2/sector/${sec.code}`} className="text-blue-500 hover:underline">View →</Link>
                      </div>
                    ))}
                  </div>
                </div>
