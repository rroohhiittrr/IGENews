              ...
              <Card className="overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link href="/en/poc-v2/article/lea-1" className={`${tc.button} rounded-lg px-4 py-2 text-xs font-bold`}>Read Full Brief</Link>
                ...
                {visibleNews.map((item, idx) => (
                  <Card key={idx} className="p-4 flex flex-col md:flex-row md:items-center justify-between gap-3 hover:border-purple-400 transition-colors">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <Link href="/en/poc-v2/article/lea-1" className="text-[10px] font-bold text-purple-600 hover:underline">Read →</Link>
                    </div>
                  </Card>
                ))}
              </div>
