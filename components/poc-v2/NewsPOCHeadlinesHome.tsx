          ...
          <div className="lg:col-span-5 p-8 flex flex-col justify-between space-y-6">
            ...
            <div className="pt-4 border-t border-gray-100 dark:border-gray-850 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Link href="/en/poc-v2/article/sec-1" className="bg-blue-600 hover:bg-blue-700 text-white font-bold text-[11px] px-5 py-2.5 rounded transition-all">
                  Read Story
                </Link>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="space-y-6">
              {topHeadlines[activeTab]
                ...
                .map((story, idx) => (
                  <Link key={idx} href="/en/poc-v2/article/sec-1" className="flex gap-6 items-start group pb-6 border-b border-gray-100 dark:border-gray-850 last:border-0 last:pb-0 block">
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 space-y-6">
          ...
          <div className="space-y-6">
            {filteredGlobalHeadlines.map((news, idx) => (
              <Link key={idx} href="/en/poc-v2/article/sec-1" className="flex gap-6 items-start group pb-6 border-b border-gray-100 dark:border-gray-855 last:border-0 last:pb-0 block">
            ...
            {[
              ...
              <div key={idx} className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden shadow-2xs hover:shadow-xs transition-all group">
                ...
                <div className="p-4 space-y-2">
                  <Link href="/en/poc-v2/company-news">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 relative rounded-3xl overflow-hidden bg-slate-950 text-white min-h-[380px] flex flex-col justify-end p-8 border border-slate-900 shadow-sm group">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="pt-2">
                <Link href="/en/poc-v2/article/sec-1" className="inline-flex items-center gap-1.5 bg-white hover:bg-gray-150 text-slate-950 font-bold text-[10px] px-4 py-2.5 rounded-lg transition-colors uppercase">
