                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-between space-y-4">
                      <div className="space-y-2">
                        ...
                        <Link href={`/en/poc-v2/article/${item.id}`} className="block">
