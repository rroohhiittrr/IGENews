      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 pt-4 space-y-8">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            ...
            <section id="rankings-section" className="space-y-4">
              ...
              <div className="flex justify-between items-center text-[10px] text-gray-550 font-semibold px-1">
                ...
                <Link href="/en/poc-v2/company-news/top/all" className="text-amber-600 hover:underline font-bold">View Full Rankings →</Link>
              </div>
              {showMethodology && (
            ...
            <section className="space-y-3">
              ...
              <Card className="p-5 space-y-2">
                ...
                <Link href={`/en/poc-v2/company-news/top/sector?sector=${industryLeaderTab}`} className="text-[10px] text-amber-600 font-bold hover:underline block pt-1">View All {INDUSTRIES_LIST.find(i => i.id === industryLeaderTab)?.name} Companies →</Link>
              </Card>
            </section>
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <Link href={`/en/poc-v2/company-news/top/all?country=${countryLeaderCode}`} className="text-[10px] text-amber-600 font-bold hover:underline block pt-1">Explore Companies in {country?.name} →</Link>
                    </>
                  );
                })()}
              </Card>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-6">
            ...
            <section className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 p-5 rounded-2xl shadow-xs space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                {INDUSTRIES_LIST.slice(0, 5).map((ind) => (
                  <Link key={ind.id} href={`/en/poc-v2/company-news/top/sector?sector=${ind.id}`} className="flex justify-between items-center p-2 rounded-xl bg-gray-50 dark:bg-gray-955 hover:bg-amber-50/50 hover:text-amber-600 transition-all text-[10px]">
              ...
              <Link href="/en/poc-v2/company-news/top/all" className="text-[10px] text-amber-600 font-bold hover:underline block text-center pt-1.5">Explore All Sectors →</Link>
            </section>
            ...
            <section className="bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-gray-800 p-5 rounded-2xl shadow-xs space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                {COUNTRIES_LIST.map((c) => (
                  <Link key={c.code} href={`/en/poc-v2/company-news/top/all?country=${c.code}`} className="flex justify-between items-center p-2 rounded-xl bg-gray-55 dark:bg-gray-955 hover:bg-amber-50/50 hover:text-amber-600 transition-all text-[10px]">
        ...
        <section className="space-y-4">
          ...
          <div className="text-center">
            <Link href="/en/poc-v2/company-news/top/news" className="text-xs font-bold text-amber-600 hover:underline inline-flex items-center gap-0.5">View Company News →<ArrowRight className="h-3.5 w-3.5" /></Link>
          </div>
        </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {BUSINESS_TYPES.map((bt) => (
              <Card key={bt.key} className="p-4 space-y-2 hover:border-amber-400 transition-all">
                ...
                <Link href={`/en/poc-v2/company-news/top/all?type=${bt.key}`} className="text-[9px] font-bold text-amber-600 hover:underline inline-flex items-center">Top {bt.label} →</Link>
              </Card>
            ))}
          </div>
        </section>
        ...
        <section className="bg-gradient-to-br from-amber-500 via-orange-600 to-[#b45309] text-white rounded-3xl p-6 md:p-8 border border-amber-400/40 space-y-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link href="/en/poc-v2/company-news/top/all" className="bg-white text-gray-950 font-bold text-xs px-6 py-2.5 rounded-lg text-center hover:bg-gray-100 transition-colors">Explore →</Link>
          </div>
        </section>
