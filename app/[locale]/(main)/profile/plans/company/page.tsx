...
export default function CompanyPlansPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      period: "month",
      badge: "STARTUP TIER",
      color: "border-orange-500/40 bg-gradient-to-b from-white via-white to-orange-50/25 relative",
      accentColor: "text-[#ea580c]",
      checkColor: "text-[#ea580c]",
      benefits: [
        "🟠 Verified Radiant Orange Checkmark badge on company profile",
    ...
    },
    {
      ...
      period: "month",
      badge: "MOST POPULAR",
      color: "border-[#0a192f] bg-gradient-to-b from-white via-white to-blue-50/30 relative shadow-xl shadow-slate-900/10",
      accentColor: "text-[#0a192f]",
      checkColor: "text-[#0a192f]",
      benefits: [
        "🔵 Verified Deep Navy Blue Checkmark badge on company profile",
    ...
    },
    {
      ...
      color: "border-amber-400/60 bg-gradient-to-b from-white via-white to-amber-50/25 relative shadow-xl shadow-amber-500/10",
      accentColor: "text-[#0a192f]",
      checkColor: "text-[#ea580c]",
      benefits: [
        "👑 Verified Dual-Tone Sovereign Apex Checkmark badge + #1 Pinned Seal",
