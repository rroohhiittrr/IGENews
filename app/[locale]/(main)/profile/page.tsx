    ...
    return (
      <div className="bg-white dark:bg-[#122238] rounded-[32px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 dark:border-white/5 space-y-6 flex flex-col relative overflow-hidden">
        ...
        <Link 
          ...
          className="w-full py-3.5 bg-[#1E3A5F] hover:bg-[#2F6FA3] text-white text-center font-bold rounded-2xl shadow-md transition-colors flex items-center justify-center gap-2 text-xs"
        >
          {ctaLabel}
