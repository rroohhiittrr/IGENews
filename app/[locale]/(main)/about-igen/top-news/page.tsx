    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--color-primary-dark)] via-[var(--color-primary-dark)] to-[var(--color-primary-dark)] px-4 py-20 md:px-6 md:py-28 text-white">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <span className="mb-4 inline-block rounded-full border border-[var(--color-accent-gold-light,#F4A024)]/30 bg-white/5 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[var(--color-accent-gold-light,#F4A024)]">
          ...
          <h1 className="mb-5 font-display text-3xl font-extrabold leading-tight md:text-5xl lg:text-6xl text-white">
            ...
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-accent-gold-light,#F4A024)] to-amber-200">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/top-news"
              className="group flex items-center gap-2 rounded-full bg-[var(--color-accent-gold-light,#F4A024)] px-8 py-3 text-sm font-bold text-[var(--color-primary)] shadow-lg transition-all hover:scale-105"
            >
      ...
      <section className="px-4 py-20 bg-[var(--color-primary)] text-white overflow-hidden relative">
        ...
        <div className="mx-auto max-w-7xl relative">
          <div className="mb-16 text-center">
            <span className="mb-4 inline-block text-xs font-bold uppercase tracking-widest text-[var(--color-accent-gold-light,#F4A024)]">
              Beyond Intelligence
            </span>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {recognitionEconomy.map((e) => (
              <div key={e.entity} className={`rounded-3xl border ${e.border} ${e.bg} p-8 backdrop-blur-sm shadow-2xl`}>
                <h3 className="text-xl font-bold mb-6 text-[var(--color-accent-gold-light,#F4A024)]">When a {e.entity} Is Featured:</h3>
