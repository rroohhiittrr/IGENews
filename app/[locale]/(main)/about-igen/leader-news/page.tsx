  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--color-primary)] via-[var(--color-primary-dark)] to-[var(--color-primary)] px-4 py-20 md:px-6 md:py-28 text-white">
        ...
        />
        {/* Glowing orb */}
        <div className="pointer-events-none absolute -top-20 right-1/4 h-80 w-80 rounded-full bg-[var(--color-accent-gold-light,#F0652E)]/10 blur-3xl" />
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-5 font-display text-3xl font-extrabold leading-tight md:text-5xl lg:text-6xl text-white">
            ...
            <br />
            <span className="text-[var(--color-accent-gold-light,#F0652E)]">Across India's Trade Universe</span>
            {" "}— In Real Time
          </h1>
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/leader-news"
              className="rounded-full bg-[var(--color-accent-gold-light,#F0652E)] px-8 py-3 text-sm font-bold text-[var(--color-primary)] shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
            >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="rounded-full bg-[var(--color-accent-gold-light,#F0652E)] px-2 py-0.5 text-xs font-bold text-[var(--color-primary)]">
                        ✓ Verified
                      </span>
                    </div>
      ...
      <section className="bg-[var(--color-primary)] px-4 py-16 md:px-6 md:py-20 text-white">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 rounded-2xl border border-[var(--color-accent-gold-light,#F0652E)]/30 bg-white/5 p-6 text-center italic text-[var(--color-accent-gold-light,#F0652E)]">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
            <div>
              ...
              <div className="rounded-2xl border border-[var(--color-accent-gold-light,#F0652E)]/30 bg-[var(--color-accent-gold-light,#F0652E)]/10 p-4 text-center">
                <p className="font-bold text-[var(--color-accent-gold-light,#F0652E)] text-lg">
            ...
            <div className="space-y-3">
              ...
              {flcBenefits.map((benefit, i) => (
                ...
                >
                  <span className="shrink-0 mt-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-[var(--color-accent-gold-light,#F0652E)] text-[var(--color-primary)] text-xs font-bold">
                    ✓
                  </span>
              ...
              <div className="pt-2">
                <Link
                  href="/reader-plans"
                  className="block w-full rounded-full bg-[var(--color-accent-gold-light,#F0652E)] py-3 text-center text-sm font-bold text-[var(--color-primary)] transition-all hover:opacity-90"
                >
