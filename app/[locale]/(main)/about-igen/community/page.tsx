    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <section className="relative overflow-hidden bg-[var(--color-primary)] px-4 py-20 text-white md:px-6 md:py-28">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-[#F0652E]">
      ...
      <section className="bg-[var(--color-primary)] px-4 py-24 text-center text-white">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mb-8 text-sm font-bold text-[#F0652E]">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link href="/reader-plans" className="rounded-full bg-[#F0652E] px-8 py-3 text-sm font-bold text-black transition-transform hover:-translate-y-1">
              Corporate Enquiry
            </Link>
          </div>
        </div>
