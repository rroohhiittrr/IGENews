    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#070b12] pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-8 space-y-8">
        <div className="space-y-1">
          <span className="text-[10px] font-black uppercase tracking-wider text-[#F4A024] flex items-center gap-1">
            <Newspaper className="w-3.5 h-3.5" />
            {tier === 'top' ? 'Enterprise' : tier} Releases
          </span>
          <h1 className="text-2xl md:text-3xl font-black text-[#1E3A5F] dark:text-white capitalize" style={{ fontFamily: 'var(--font-display)' }}>
