    ...
    <div className="min-h-screen bg-[#f4f7fb] dark:bg-[#0b1329] py-8 px-4 md:px-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex justify-start">
          <button 
            onClick={() => router.back()}
            className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#122238] border border-gray-150 dark:border-white/5 rounded-xl text-xs font-bold text-[#1E3A5F] dark:text-white shadow-sm hover:bg-gray-50 dark:hover:bg-white/10 transition-all"
          >
            ...
            <div className="shrink-0">
              {avatarBase64 ? (
                <img 
                  src={avatarBase64} 
                  alt={displayName} 
                  className="w-[120px] h-[120px] rounded-full object-cover border-4 border-[#1E3A5F]/10 shadow-md"
                />
              ) : (
                <div className="w-[120px] h-[120px] rounded-full bg-gradient-to-br from-[#1E3A5F] to-[#2F6FA3] text-white flex items-center justify-center font-bold text-3xl uppercase shadow-md border-4 border-white dark:border-[#122238]">
            ...
            <div className="flex-1 text-center md:text-left space-y-4 pt-1">
              <div className="space-y-1.5">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5">
                  <h1 className="text-2xl md:text-3xl font-bold text-[#1E3A5F] dark:text-white">{displayName}</h1>
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === "interests" && (
              <motion.div 
                ...
                className="space-y-4"
              >
                <h3 className="font-bold text-[#1E3A5F] dark:text-white text-sm">Followed Sectors & Interests</h3>
                ...
                <div className="flex flex-wrap gap-2.5 pt-2">
                  {sectors.map((sectorId) => (
                    <span 
                      key={sectorId} 
                      className="px-4 py-2 bg-[#f4f7fb] dark:bg-white/5 text-[#1E3A5F] dark:text-gray-300 text-xs font-bold rounded-xl border border-gray-150 dark:border-white/5 shadow-sm capitalize"
                    >
            ...
            {activeTab === "comments" && (
              <motion.div 
                ...
                className="space-y-4"
              >
                <h3 className="font-bold text-[#1E3A5F] dark:text-white text-sm">Public Comments Bank</h3>
                ...
                <div className="space-y-4 pt-2">
                  {[
                    ...
                    <div key={com.id} className="p-4 bg-[#f4f7fb] dark:bg-white/5 rounded-2xl space-y-2 border border-transparent">
                      ...
                      <div className="flex items-center gap-1.5 text-[10px] text-[#F4A024] font-bold">
            ...
            {activeTab === "activity" && (
              <motion.div 
                ...
                className="space-y-4"
              >
                <h3 className="font-bold text-[#1E3A5F] dark:text-white text-sm">Public Reading Activity</h3>
                ...
                <div className="p-6 bg-orange-500/5 border border-dashed border-orange-500/20 rounded-2xl flex flex-col items-center justify-center text-center max-w-md mx-auto space-y-3">
                  ...
                  <h4 className="text-xs font-bold text-[#1E3A5F] dark:text-white">Activity History is Private</h4>
