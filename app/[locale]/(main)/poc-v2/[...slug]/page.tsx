...
import { NEWS_POC_MENU_ITEMS, MegaMenuItem, SubItem, SubSubItem } from "@/components/poc-v2/newsPOCData";
import NewsPOCHeadlinesHome from "@/components/poc-v2/NewsPOCHeadlinesHome";
import NewsPOCCompanyNewsHome from "@/components/poc-v2/NewsPOCCompanyNewsHome";
import NewsPOCCompanyNewsSubmenu from "@/components/poc-v2/NewsPOCCompanyNewsSubmenu";
import NewsPOCTrendingHome from "@/components/poc-v2/NewsPOCTrendingHome";
import NewsPOCTrendingMostLikedMySectors from "@/components/poc-v2/NewsPOCTrendingMostLikedMySectors";
import NewsPOCTrendingMostLikedAllSectors from "@/components/poc-v2/NewsPOCTrendingMostLikedAllSectors";
import NewsPOCTrendingMostSharedMySectors from "@/components/poc-v2/NewsPOCTrendingMostSharedMySectors";
import NewsPOCTrendingMostSharedAllSectors from "@/components/poc-v2/NewsPOCTrendingMostSharedAllSectors";
import NewsPOCTrendingMostCommentedMySectors from "@/components/poc-v2/NewsPOCTrendingMostCommentedMySectors";
import NewsPOCTrendingMostCommentedAllSectors from "@/components/poc-v2/NewsPOCTrendingMostCommentedAllSectors";
import NewsPOCHeadlinesAIEditorMySector from "@/components/poc-v2/NewsPOCHeadlinesAIEditorMySector";
import NewsPOCHeadlinesAIEditorAllSectors from "@/components/poc-v2/NewsPOCHeadlinesAIEditorAllSectors";
import NewsPOCHeadlinesIntelligenceEditorMySector from "@/components/poc-v2/NewsPOCHeadlinesIntelligenceEditorMySector";
import NewsPOCHeadlinesIntelligenceEditorAllSectors from "@/components/poc-v2/NewsPOCHeadlinesIntelligenceEditorAllSectors";
import NewsPOCHeadlinesSMEEditorMySector from "@/components/poc-v2/NewsPOCHeadlinesSMEEditorMySector";
import NewsPOCHeadlinesSMEEditorAllSectors from "@/components/poc-v2/NewsPOCHeadlinesSMEEditorAllSectors";
import NewsPOCHeadlinesViksitBharatPanelEditorMySector from "@/components/poc-v2/NewsPOCHeadlinesViksitBharatPanelEditorMySector";
import NewsPOCHeadlinesViksitBharatPanelEditorAllSectors from "@/components/poc-v2/NewsPOCHeadlinesViksitBharatPanelEditorAllSectors";
import NewsPOCLeaderNewsHome from "@/components/poc-v2/NewsPOCLeaderNewsHome";
import NewsPOCLeaderNewsSubmenu from "@/components/poc-v2/NewsPOCLeaderNewsSubmenu";
import NewsPOCExpertNewsHome from "@/components/poc-v2/NewsPOCExpertNewsHome";
import NewsPOCExpertNewsSubmenu from "@/components/poc-v2/NewsPOCExpertNewsSubmenu";
import NewsPOCSectorNewsHome from "@/components/poc-v2/NewsPOCSectorNewsHome";
import NewsPOCSectorNewsSubmenu from "@/components/poc-v2/NewsPOCSectorNewsSubmenu";
import NewsPOCCountryNewsHome from "@/components/poc-v2/NewsPOCCountryNewsHome";
import NewsPOCCountryNewsSubmenu from "@/components/poc-v2/NewsPOCCountryNewsSubmenu";
import NewsPOCCommunitiesHome from "@/components/poc-v2/NewsPOCCommunitiesHome";
import NewsPOCCommunitiesSubmenu from "@/components/poc-v2/NewsPOCCommunitiesSubmenu";
import NewsPOCMyNewsHome from "@/components/poc-v2/NewsPOCMyNewsHome";
import NewsPOCMyNewsSubmenu from "@/components/poc-v2/NewsPOCMyNewsSubmenu";
import NewsPOCArticleDetail from "@/components/poc-v2/NewsPOCArticleDetail";
...
export default function NewsPOCCatchAllPage() {
  ...
  if (isFeedPage) {
    if (categoryKey === "sector" && activeSub === "all") {
      return (
        <NewsPOCFullDiscoveryView
          ...
          onBack={() => {
            setActiveSub("my");
            router.push("/en/poc-v2/feed/sector");
          }}
        />
      );
    }
    ...
    if (categoryKey === "industry" && activeSub === "all") {
      return (
        <NewsPOCAllIndustryView 
          onBack={() => {
            setActiveSub("my");
            router.push("/en/poc-v2/feed/industry");
          }} 
        />
      );
    }
    ...
    if (categoryKey === "country" && activeSub === "my") {
      return (
        <NewsPOCAllCountryFeedView 
          onBack={() => {
            router.push("/en/poc-v2/feed");
          }} 
        />
      );
    }
                ...
                <button
                  ...
                  onClick={() => {
                    if (sub.key === "intelligence") {
                      if (categoryKey === "sector") {
                        router.push("/en/poc-v2/sector-news/intelligence");
                        return;
                      }
                      if (categoryKey === "industry") {
                        router.push("/en/poc-v2/sector-news/industry");
                        return;
                      }
                      if (categoryKey === "country") {
                        router.push("/en/poc-v2/country-news/intelligence");
                        return;
                      }
                      if (categoryKey === "leader") {
                      ...
                      if (categoryKey === "reader") {
                        router.push("/en/poc-v2/my-news/intelligence");
                        return;
                      }
                    }
                    if (sub.key === "all") {
                      router.push(`/en/poc-v2/feed/${categoryKey}/all`);
                      return;
                    }
                    if (sub.key === "my") {
                      router.push(`/en/poc-v2/feed/${categoryKey}/my`);
                      return;
                    }
                ...
                <div className="relative rounded-2xl overflow-hidden bg-slate-950 text-white min-h-[340px] flex flex-col justify-end p-8 border border-slate-900 shadow-sm group">
                  ...
                  <div className="relative z-10 space-y-3">
                    ...
                    <div className="pt-2 flex items-center gap-3">
                      <Link 
                        href={`/en/poc-v2/article/${filteredArticles[0].id || "sec-1"}`}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            <Link href={`/en/poc-v2/article/${art.id}`} className="block">
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {articles.slice(1).map((art, idx) => (
                      <Link 
                        key={idx} 
                        href={`/en/poc-v2/article/${art.id || "sec-1"}`} 
                  ...
                  <div className="space-y-5 pt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      {[
                        ...
                        <Link
                          key={tIdx}
                          href={`/en/poc-v2/article/${trendArt.id}`}
    ...
    <div className="space-y-8 col-span-12">
        ...
        <div className="relative z-10 space-y-4 max-w-4xl">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-6 border-t border-white/10 pt-4 text-xs font-semibold text-slate-300">
            ...
            <div>
              ...
              <span className="text-sm font-bold text-[#F0652E]">92/100</span>
            </div>
            <div className="ml-auto">
              <Link href="/en/poc-v2/article/sec-1" className="bg-white text-gray-950 hover:bg-gray-100 font-bold px-5 py-2.5 rounded-lg transition-colors flex items-center gap-1.5 text-[10px]">
      ...
      <div className="bg-white dark:bg-[#0f172a] border border-gray-255 dark:border-gray-800 p-6 rounded-2xl shadow-xs flex flex-col md:flex-row gap-6 items-center">
        ...
        <div className="w-full md:w-56 p-4 bg-gradient-to-br from-[#1a0f0a] to-slate-950 text-white rounded-xl border border-gray-800 text-center">
          ...
          <span className="text-2xl font-bold text-[#F0652E] block mt-1">$42.8B</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-4">
        ...
        <div className="lg:col-span-3 bg-gradient-to-br from-[#0c1424] to-[#162136] border border-slate-800 text-white p-5 rounded-2xl shadow-xs space-y-3">
          ...
          <Link href="/eoi" className="block text-center bg-[#F0652E] hover:bg-[#D44F1C] text-gray-950 font-bold text-xs py-2 rounded transition-colors">
            Upgrade Access
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-[#0f172a] text-white border border-gray-800 p-5 rounded-xl shadow-xs space-y-4">
            ...
            <button className="w-full bg-[#1D1D46] hover:bg-[#152e4f] text-white font-bold text-[10px] py-2 rounded-lg transition-colors">
              Analyze Portfolio
            </button>
          </div>
        </div>
                ...
                {subscribed ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      className="w-full bg-[#1D1D46] hover:bg-[#152e4f] text-white text-xs font-bold py-2 rounded-lg transition-colors"
                    >
                      Subscribe
                    </button>
                  </div>
              ...
              <div className="flex items-center gap-1.5 bg-gray-50 dark:bg-gray-955 p-1 rounded-xl border border-gray-200 dark:border-gray-800 shadow-xs">
                {[
                  ...
                  <button
                    key={sub.key}
                    onClick={() => {
                      const newSlug = `/en/poc-v2/headlines/${editorSlug}/${sub.key}`;
                      router.push(newSlug);
                    }}
                    className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                      subTab === sub.key
                ...
                {articles.length > 0 && (
                  <div className="relative rounded-2xl overflow-hidden bg-slate-955 text-white min-h-[320px] flex flex-col justify-end p-8 border border-slate-900 shadow-sm group">
                    ...
                    <div className="relative z-10 space-y-3">
                      ...
                      <div className="pt-2">
                        <Link href={`/en/poc-v2/article/${articles[0]?.id || "sec-1"}`} className="bg-white text-gray-950 hover:bg-gray-105 font-bold px-4 py-2 rounded text-[10px]">
                          Read Full Analysis
                        </Link>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-12 lg:col-span-4 space-y-6">
                ...
                <div className="bg-[#0f172a] text-white border border-slate-800 p-5 rounded-2xl shadow-xs space-y-3">
                  ...
                  <Link href="/eoi" className="block text-center bg-[#1D1D46] hover:bg-[#152e4f] text-white font-bold text-[10px] py-2 rounded transition-colors">
                    Learn More
                  </Link>
                </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1 bg-gray-100 dark:bg-gray-900 p-0.5 rounded-xl border border-gray-200 dark:border-gray-800">
                {[
                  ...
                  <button
                    key={sub.key}
                    onClick={() => router.push(`/en/poc-v2/trending/${trendSlug}/${sub.key}`)}
                ...
                <div className="relative rounded-2xl overflow-hidden bg-slate-950 text-white min-h-[340px] flex flex-col justify-end p-8 border border-slate-900 shadow-sm group">
                  ...
                  <div className="relative z-10 space-y-3">
                    ...
                    <div className="flex gap-3 pt-2">
                      <Link href={`/en/poc-v2/article/${articles[0]?.id || "sec-1"}`} className="bg-amber-500 hover:bg-amber-600 text-gray-950 font-bold text-[10px] px-4 py-2 rounded transition-all">
                        Read Full Story
                      </Link>
  ...
  const canonicalUrl = `https://indiaglobalnews.com/poc-v2/${slugParts.join("/")}`;
  const proposedSlug = `/poc-v2/${slugParts.join("/")}`;
      ...
      <div className="overflow-hidden rounded-3xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-xl">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="border-t border-gray-100 dark:border-gray-850 pt-6 flex items-center justify-between">
            <Link href="/poc-v2" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs px-5 py-2.5 rounded-lg shadow-sm">
