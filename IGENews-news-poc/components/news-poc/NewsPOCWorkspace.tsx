...
const MODULES_DATA: ModuleConfig[] = [
  ...
  },
  {
    ...
    name: "My News",
    slug: "my-news",
    purpose: "Personal workspace for personalized feed, activity tracking, and content contribution.",
    details: "The user's central workspace. Save articles, track user contributions, view activity analytics, and configure AI summary settings.",
    color: "#475569",
    icon: "👤",
    tier: "Verified/Pro",
...
export default function NewsPOCWorkspace() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 lg:px-6">
      {/* Hero Header */}
      <div className="mb-8 rounded-2xl bg-gradient-to-r from-[#1D1D46] via-[#0642BA] to-[#1E293B] p-8 text-white shadow-lg">
