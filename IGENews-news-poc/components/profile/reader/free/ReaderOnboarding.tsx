        ...
        <div className="bg-gradient-to-br from-[#1D1D46] to-[#122238] rounded-3xl p-6 md:p-8 mb-8 border border-white/10 text-white relative overflow-hidden shadow-xl">
          ...
          <div className="relative z-10 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold tracking-widest text-[#F0652E] uppercase bg-[#F0652E]/10 px-2 py-1 rounded-md">
                  ...
                  {avatarBase64 ? (
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <button 
                        ...
                        className="px-3 py-1.5 bg-[#1D1D46] hover:bg-[#0642BA] text-white text-[9px] font-bold rounded-xl flex items-center gap-1 shadow-sm transition-all"
                      >
          ...
          >
            <div className="bg-white dark:bg-[#122238] rounded-3xl p-6 md:p-10 border border-gray-100 dark:border-white/5 space-y-6 shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-2">
                <h2 className="text-xl md:text-2xl font-bold text-[#1D1D46] dark:text-white">
              ...
              <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl border border-gray-150 dark:border-transparent space-y-2 text-left">
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className="px-4 py-2 bg-[#1D1D46] hover:bg-[#0642BA] text-white text-xs font-bold rounded-xl flex items-center gap-1 shrink-0"
                  >
              ...
              <div className="bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 rounded-2xl p-5 text-left space-y-4">
                <h4 className="text-xs font-bold text-[#1D1D46] dark:text-white uppercase tracking-wider flex items-center gap-1.5">
                  <Award className="w-4 h-4 text-[#F0652E]" /> Free Plan vs Pro Plan Preview
                </h4>
                  ...
                  <table className="w-full text-[10px] border-collapse">
                    <thead>
                      <tr className="border-b border-gray-200 dark:border-white/10 text-gray-400 uppercase text-left font-black">
                        ...
                        <th className="pb-2 text-center text-[#F0652E]">PRO (Upgrade)</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-150 dark:divide-white/5 text-gray-600 dark:text-gray-300">
                      ...
                      <tr>
                        ...
                        <td className="py-2 text-center text-emerald-600 font-bold">YES</td>
                        <td className="py-2 text-center text-[#F0652E] font-bold">Unlimited + Exclusive</td>
                      </tr>
                      <tr>
                        <td className="py-2 font-medium">SME Expert Columns</td>
                        <td className="py-2 text-center">5/month</td>
                        <td className="py-2 text-center text-[#F0652E] font-bold">Unlimited</td>
                      </tr>
                      <tr>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  ...
                  className="flex-1 py-3.5 bg-[#1D1D46] hover:bg-[#0642BA] text-white font-bold rounded-2xl shadow-md transition-colors text-xs"
                >
                  Go to My Dashboard
                </button>
                <button
                  onClick={() => router.push(`/${locale}/profile/plans/reader`)}
                  className="flex-1 py-3.5 bg-gray-100 hover:bg-gray-250 dark:bg-white/5 dark:hover:bg-white/10 text-[#1D1D46] dark:text-white font-bold rounded-2xl transition-colors text-xs"
                >
